...
void __EntryFunction__()
{
	...
	StringCopy(&Local_97, "CELL_214", 16);
	StringCopy(&Local_101, "CELL_243", 16);
	StringCopy(&Local_105, "CELL_244", 16);
	StringCopy(&Local_109, "CELL_265", 16);
	StringCopy(&Local_113, "CELL_300", 16);
...
void func_5()
{
	...
	if (iLocal_119)
	{
		if (PAD::IS_CONTROL_JUST_RELEASED(2, Global_21035))
		{
			iLocal_119 = 0;
		}
		return;
...
int func_36(int* iParam0)
{
	...
	if (!PAD::IS_CONTROL_JUST_PRESSED(2, Global_21035))
	{
		return 0;
	}
	func_37();
...
int func_40(int* iParam0)
{
	...
	if (!PAD::IS_CONTROL_JUST_PRESSED(2, Global_21038))
	{
		return 0;
	}
	func_37();
...
int func_41(int* iParam0)
{
	...
	if (!PAD::IS_CONTROL_JUST_PRESSED(2, Global_21036))
	{
		return 0;
	}
	func_42();
...
void func_43(int* iParam0)
{
	...
	if (PAD::IS_CONTROL_JUST_PRESSED(2, Global_21042) || PAD::IS_CONTROL_JUST_PRESSED(2, 181))
	{
		func_46();
		iParam0->f_1 = MISC::GET_GAME_TIMER() + 50;
	}
	if (PAD::IS_CONTROL_JUST_PRESSED(2, Global_21043) || PAD::IS_CONTROL_JUST_PRESSED(2, 180))
	{
		func_44();
		iParam0->f_1 = MISC::GET_GAME_TIMER() + 50;
	}
