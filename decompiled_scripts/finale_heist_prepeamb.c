...
void func_254()
{
	StringCopy(&(Global_8757[3 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}

void func_255()
{
	StringCopy(&(Global_8757[2 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}

void func_256()
{
	StringCopy(&(Global_8757[1 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}

void func_257()
{
	StringCopy(&(Global_8757[0 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}
