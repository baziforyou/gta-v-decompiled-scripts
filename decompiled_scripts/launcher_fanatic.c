	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113431[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_301(&(Global_113431[Var0.f_0 /*10*/].f_9));
			}
		}
		func_286(&Var0, 1);
	}
...
void func_200(int iParam0, char* sParam1, char* sParam2, int iParam3, bool bParam4)
{
...
int func_202(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
...
float func_206(int iParam0, struct<3> Param1, bool bParam4)
{
	struct<3> Var0;
...
int func_207(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	var uVar0;
...
int func_219(var uParam0, bool bParam1)
{
	...
	if ((func_256(*uParam0) || func_254(*uParam0)) || Global_79990 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
{
	if ((func_255() && Global_101893.f_11 == 6) && iParam0 == func_178(&(Global_101893.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_260(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
...
int func_261(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
void func_268(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_269(iParam0);
...
int func_283(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	int iVar0;
...
int func_284(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
...
int func_285(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
