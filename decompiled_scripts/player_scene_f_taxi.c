...
int func_4()
{
	...
	if (!func_3(&uVar0))
	{
		...
		else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_99198))
		{
			...
			fVar1 = PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_99198);
			if (!func_5(Global_101614, iLocal_73, 2))
			{
				if (fVar1 >= 0.9f)
				{
					PED::SET_PED_INTO_VEHICLE(Global_101614, iLocal_73, 2);
				}
			}
			if (!iLocal_179)
			{
...
int func_8(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_9(Global_101614) && iParam1 != 0)
		{
			Global_101614 = 0;
		}
	}
...
void func_12()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_15(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_13(iVar0) && (!func_17(14) || Global_113292))
			{
...
void func_22()
{
	...
	iVar0 = 0;
	while ((!ENTITY::DOES_ENTITY_EXIST(Global_101614) || !ENTITY::DOES_ENTITY_EXIST(iLocal_73)) || (!STREAMING::HAS_MODEL_LOADED(iLocal_72) && iVar0 < 400))
	{
	...
	{
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Global_101614, Global_96872);
		AUDIO::SET_AMBIENT_VOICE_NAME(Global_101614, "A_F_Y_BevHills_01_White_FULL_01");
	}
...
int func_26(struct<109> Param0, var uParam109)
{
	...
	switch (Param0.f_2)
	{
		...
		case 2:
			*uParam109 = { Global_100004[0 /*109*/] };
			uParam109->f_109 = joaat("script_task_stand_still");
			uParam109->f_110 = joaat("script_task_stand_still");
			func_28(uParam109);
			uParam109->f_118 = Global_101592[0];
			return 1;
			break;
		
		case 3:
			*uParam109 = { Global_100004[1 /*109*/] };
			uParam109->f_109 = joaat("script_task_stand_still");
			uParam109->f_110 = joaat("script_task_stand_still");
			func_28(uParam109);
			uParam109->f_118 = Global_101592[1];
			return 1;
			break;
		
		case 4:
			*uParam109 = { Global_100004[2 /*109*/] };
			uParam109->f_109 = joaat("script_task_stand_still");
			uParam109->f_110 = joaat("script_task_stand_still");
			func_28(uParam109);
			uParam109->f_118 = Global_101592[2];
			return 1;
			break;
		...
		case 5:
			*uParam109 = { Param0 };
			...
			uParam109->f_110 = joaat("script_task_stand_still");
			func_28(uParam109);
			uParam109->f_118 = Global_101592[Param0.f_3];
			return 1;
			break;
...
int func_31(int iParam0, var uParam1, int iParam2)
{
	...
	if (!func_32(Global_101297[iParam0 /*98*/], 0, -1))
	{
		func_30(iParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_114344.f_2367.f_539.f_2310[0];
			StringCopy(sParam2, func_51(Global_114344.f_2367.f_539.f_2314[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_114344.f_2367.f_539.f_2310[1];
			StringCopy(sParam2, func_51(Global_114344.f_2367.f_539.f_2314[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_114344.f_2367.f_539.f_2310[2];
			StringCopy(sParam2, func_51(Global_114344.f_2367.f_539.f_2314[2]), 32);
			return 1;
			break;
