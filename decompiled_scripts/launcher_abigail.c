...
void __EntryFunction__()
{
	...
	Local_90 = { -1593.813f, 5221.235f, 1.94482f };
	Local_93 = { -1603.986f, 5243.624f, 4.940323f };
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113431[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_304(&(Global_113431[Var0.f_0 /*10*/].f_9));
			}
		}
		func_287(&Var0, 1);
	}
...
int func_160(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
int func_171(int iParam0)
{
	...
	iVar0 = func_173(&(Global_113431[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
{
	return func_176(iParam0, Global_44375);
}
...
int func_182(struct<3> Param0, bool bParam3)
{
	int iVar0;
...
int func_200(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
...
{
	if ((func_262() && Global_101893.f_11 == 6) && iParam0 == func_179(&(Global_101893.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_268(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
...
int func_269(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
int func_284(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	int iVar0;
...
int func_285(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
...
int func_286(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
