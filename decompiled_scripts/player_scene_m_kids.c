...
void func_3(int iParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		switch (iLocal_242[iParam1])
		{
				...
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, &sLocal_348, &(Local_429[iParam1 /*16*/]), 2))
				{
					...
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_99198))
					{
						if (!ENTITY::IS_ENTITY_DEAD(iLocal_252[iParam1], false))
						{
							...
							{
								if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_99198) > 0.817f)
								{
						...
						if (PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_99198) > fLocal_480)
						{
			...
			case 1:
				if (iLocal_248[iParam1] != Global_96874[iLocal_245[iParam1]])
				{
					if (!ENTITY::DOES_ENTITY_EXIST(Global_101614))
					{
						Global_96874[iLocal_245[iParam1]] = 140;
						Global_96890 = iLocal_248[iParam1];
...
void func_24()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_27(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_25(iVar0) && (!func_29(14) || Global_113292))
			{
		...
		if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_99198))
		{
			...
			while (iVar0 < iLocal_236)
			{
				if (!PED::IS_PED_INJURED(iLocal_236[iVar0]))
				{
					...
					TASK::TASK_SYNCHRONIZED_SCENE(iLocal_236[iVar0], Global_99198, &sLocal_348, &(Local_429[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
					iLocal_242[iVar0] = 0;
				}
				else
				{
				...
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_252[iVar0], false))
				{
					...
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_252[iVar0], Global_99198, &(Local_301[iVar0 /*16*/]), &sLocal_348, 8f, 8f, 0, 1000f);
				}
				iVar0++;
			}
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_462) && iLocal_467)
...
int func_36()
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_99197))
	{
		...
		while (iVar0 < iLocal_236)
		{
			if (!PED::IS_PED_INJURED(iLocal_236[iVar0]))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(iLocal_236[iVar0], Global_99197, &sLocal_348, &(Local_396[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1000f, 0);
			}
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_252[iVar0], false))
			{
				if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_268[iVar0 /*16*/])))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(iLocal_252[iVar0], Global_99197, &(Local_268[iVar0 /*16*/]), &sLocal_348, 8f, 8f, 0, 1000f);
				}
				else
				{
					if (!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_252[iVar0]))
		...
		if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_462))
		{
			...
			if (iLocal_69 == 156)
			{
				func_37(&uLocal_70, 3, Global_101614, "JIMMY", 0, 1);
...
int func_38(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_39(Global_101614) && iParam1 != 0)
		{
			Global_101614 = 0;
		}
	}
	...
	switch (iParam1)
	{
		...
		case 9:
			if (iParam2 == 108)
			{
				iVar0 = 12;
				iVar1 = 32;
				if (BitTest(Global_114344.f_2367.f_539.f_3816[0 /*166*/][iVar0 /*11*/][(iVar1 / 32)], (iVar1 % 32)))
				{
...
int func_140(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_79527[1 /*14*/] = { func_70(iVar10, iParam1, iParam2, -1) };
		if (!func_166(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_79527[1 /*14*/] = { func_70(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_79527[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_79527[1 /*14*/] = { func_70(iVar10, 14, uVar28[iVar1], -1) };
							func_157(iParam0, Global_79527[1 /*14*/].f_12, Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4);
							func_163(14);
							if (Global_79525 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_50(iVar0), Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_50(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_50(iVar0), Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4, iParam4);
						}
						func_163(iVar0);
						if (Global_79525 == 1)
						{
			...
			{
				Global_79527[1 /*14*/] = { func_70(iVar10, iVar0, func_147(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_79527[1 /*14*/] = { func_70(iVar10, 14, uVar69[iVar1], -1) };
			func_157(iParam0, Global_79527[1 /*14*/].f_12, Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4);
			func_163(14);
			if (Global_79525 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_50(iParam1), Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_50(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_50(iParam1), Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4, iParam4);
		}
		if (Global_79525 == 1)
		{
			iVar2 = 0;
...
int func_141(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_49(iParam0, Global_114344.f_2367.f_539[iVar0 /*65*/].f_64, Global_114344.f_2367.f_539[iVar0 /*65*/].f_63))
		{
...
int func_146(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_49(iParam0, Global_114344.f_2367.f_539[iVar0 /*65*/].f_61, Global_114344.f_2367.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_173(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_114344.f_2367.f_539.f_2310[0];
			StringCopy(sParam2, func_188(Global_114344.f_2367.f_539.f_2314[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_114344.f_2367.f_539.f_2310[1];
			StringCopy(sParam2, func_188(Global_114344.f_2367.f_539.f_2314[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_114344.f_2367.f_539.f_2310[2];
			StringCopy(sParam2, func_188(Global_114344.f_2367.f_539.f_2314[2]), 32);
			return 1;
			break;
