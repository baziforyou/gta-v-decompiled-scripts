...
void __EntryFunction__()
{
	...
	sLocal_629 = "left_";
	Local_630 = { 261.9341f, 126.2429f, 95.15405f };
	Local_633 = { 270.6759f, 152.4763f, 109.2356f };
	fLocal_636 = 16f;
	Local_637 = { 261.9341f, 126.2429f, 107.6541f };
	Local_640 = { 248.354f, 87.01792f, 92.389f };
	fLocal_643 = 16f;
	Local_644 = { 256.6779f, 126.573f, 99.54784f };
	Local_647 = { 266.4471f, 123.412f, 105.6728f };
	fLocal_650 = 5.75f;
	...
	while (true)
	{
		...
		if (iLocal_45 <= 0)
		{
			...
			{
				if ((!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 243.6443f, 123.7193f, 97.59898f, 262.4353f, 116.8746f, 107.4762f, 32.25f, false, true, 0) && (MISC::GET_GAME_TIMER() - iLocal_562) > 5000) && !PED::IS_PED_INJURED(Local_202[iVar1 /*18*/]))
				{
...
void func_3(int iParam0, char* sParam1, char* sParam2, int iParam3, bool bParam4)
{
...
void func_25()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_28(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_26(iVar0) && (!func_17(14) || Global_113292))
			{
						...
						if (iVar6 != -1)
						{
							...
							if (!PED::IS_PED_INJURED(Local_202[iVar5 /*18*/]) && (iVar6 != -1 && !PED::IS_PED_INJURED(Local_202[iVar6 /*18*/])))
							{
								if ((PED::IS_PED_IN_VEHICLE(Local_202[iVar5 /*18*/], Local_129[iVar0 /*18*/], false) && (iVar6 != -1 && PED::IS_PED_IN_VEHICLE(Local_202[iVar6 /*18*/], Local_129[iVar0 /*18*/], false))) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_89, false))
								{
									...
									{
										TASK::SET_DRIVE_TASK_MAX_CRUISE_SPEED(Local_202[iVar5 /*18*/], fVar7, 0);
										iVar8 = 0;
...
void func_55()
{
	...
	while (iVar0 < Local_202.f_0)
	{
		...
		else if (!PED::IS_PED_INJURED(Local_202[iVar0 /*18*/]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_202[iVar0 /*18*/], false))
		{
			...
			HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Local_202[iVar0 /*18*/].f_1, "EP_PAPBLIP");
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < Local_129.f_0)
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Local_129[iVar0 /*18*/], false))
		{
			...
			else if (!func_58(Local_129[iVar0 /*18*/], 1, 0, 0, 0, 0, 1, 0, 1))
			{
				...
				HUD::SET_BLIP_NAME_FROM_TEXT_FILE(Local_129[iVar0 /*18*/].f_1, "EP_PAPBLIP");
...
void func_65(int iParam0, struct<3> Param1, float fParam4)
{
	...
	if (Global_4 || bLocal_68)
	{
		ENTITY::SET_ENTITY_INVINCIBLE(Local_202[iParam0 /*18*/], true, 0);
...
void func_86(int iParam0, bool bParam1)
{
	...
	if (bParam1 <= func_103(iParam0))
	{
		...
		{
			func_88(func_94(iParam0, bParam1), Local_41.f_0, Local_41.f_1);
		}
...
void func_89()
{
	...
	{
		func_91(13, SYSTEM::FLOOR(Global_114344.f_10198.f_3853));
	}
...
void func_111()
{
	...
	if (!PED::IS_PED_INJURED(iLocal_84) && SYSTEM::VDIST2(Local_58, Local_61) < 900f)
	{
		...
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_84, -2065892691);
	}
	else
	{
		func_202();
...
void func_118(bool bParam0)
{
	...
	else if (BitTest(Global_114344.f_20568.f_471, bParam0) || BitTest(Global_2359296[func_120() /*5571*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_114344.f_20568.f_471), bParam0);
...
int func_130(int iParam0, int iParam1)
{
	...
	if (func_140(&Global_4546910))
	{
		if (func_138(&Global_4546910, iParam0))
		{
			return 0;
		}
		if (func_131(&Global_4546910, iParam0))
		{
			return 1;
		}
	}
...
void func_134(var uParam0)
{
	...
	func_136(uParam0, (Global_4546909 - 0.5f));
}
...
void func_152(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
void func_161()
{
	...
	if (bLocal_366 && !PED::IS_PED_INJURED(iLocal_84))
	{
		...
		else if (iLocal_367 != 100)
		{
			...
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_89, 225.5938f, 681.1489f, 188.4262f, 232.02f, 681.3113f, 191.9843f, 8.75f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 226.6788f, 681.0637f, 189f, 1f, 1f, 2.5f, true, true, 0))
				{
					SYSTEM::SETTIMERA(0);
					iLocal_367 = 100;
				}
			...
			else if (!PED::IS_PED_IN_VEHICLE(iLocal_84, iLocal_89, false))
			{
				...
				{
					TASK::TASK_ENTER_VEHICLE(iLocal_84, iLocal_89, -1, func_180(iLocal_89), 2f, 8388608, 0);
				}
			}
		}
	}
...
int func_167(char* sParam0, bool bParam1)
{
	if (bParam1)
	{
		if (!iLocal_70)
...
bool func_169(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)
{
	func_21(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
void func_184()
{
	if (!PED::IS_PED_INJURED(iLocal_84) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_89, false))
	{
		...
		switch (iLocal_367)
		{
			...
			case 1:
				func_186();
				if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_84, 243.5571f, 77.51265f, 90.08002f, 268.2083f, 144.2189f, 109.853f, 23.25f, false, true, 0))
				{
					iLocal_367++;
				...
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_89, false))
				{
					...
					if ((ENTITY::IS_ENTITY_AT_ENTITY(iLocal_89, iLocal_84, Global_22, false, true, 0) && func_182(iLocal_89)) && (SYSTEM::TIMERA() > 6000 || !bLocal_366))
					{
						...
						else
						{
							...
							TASK::CLEAR_PED_TASKS(iLocal_84);
							TASK::TASK_ENTER_VEHICLE(iLocal_84, iLocal_89, -1, func_180(iLocal_89), 1f, 8388608, 0);
						}
					}
				}
				break;
			...
			case 5:
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_89, false))
				{
					...
					else
					{
						if (!Global_4 && !bLocal_68)
						{
							if ((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_89, false) && !PED::IS_PED_IN_VEHICLE(iLocal_84, iLocal_89, true)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_89, 225.1779f, 125.6632f, 113.6647f, 262.3032f, 111.8771f, 97.16339f, 37f, false, true, 0))
							{
								if (bLocal_366)
								{
...
void func_188(struct<3> Param0, bool bParam3)
{
...
int func_193(int iParam0)
{
	if (func_196())
	{
		...
		if (func_95(Global_114333))
		{
			func_194(0);
		}
		HUD::SET_MISSION_NAME(true, "RE_TITLE");
		if (iParam0 && func_95(Global_114333))
		{
...
int func_196()
{
	switch (func_197(&Global_33341, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_197(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	int iVar0;
...
{
	return func_200(iParam0, Global_44375);
}
...
void func_202()
{
	...
	while (iVar0 < Local_202.f_0)
	{
		if (!PED::IS_PED_INJURED(Local_202[iVar0 /*18*/]))
		{
			...
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_202[iVar0 /*18*/], -2065892691);
...
int func_205(float fParam0, bool bParam1)
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_206(int iParam0, var uParam1)
{
	switch (iParam0)
	{
		...
		case 5:
			func_207(uParam1, "Barry3A", func_209(iParam0), 1, 1, 0, 1199.27f, -1255.63f, 34.23f, 381, "BARSTASH", 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_208(iParam0), 0, 1);
			break;
		...
		case 8:
			func_207(uParam1, "Dreyfuss1", func_209(iParam0), 0, 2, 4, -1458.97f, 485.99f, 115.38f, 66, "LETTERS_HINT", 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_208(iParam0), 0, 0);
			break;
		...
		case 38:
			func_207(uParam1, "Nigel1A", func_209(iParam0), 0, 12, 1, -558.65f, 284.49f, 90.86f, 149, "NIGITEMS", 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_208(iParam0), 1, 1);
			break;
		...
		case 49:
			func_207(uParam1, "Paparazzo3A", func_209(iParam0), 0, 14, 2, 305.52f, 157.19f, 102.94f, 389, "PAPPHOTO", 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_208(iParam0), 0, 1);
			break;
		...
		case 58:
			func_207(uParam1, "Tonya1", func_209(iParam0), 0, 17, 4, -14.39f, -1472.69f, 29.58f, 66, "AM_H_RCFS", -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_208(iParam0), 0, 1);
			break;
...
void func_216()
{
	...
	if (Global_4 || bLocal_68)
	{
		ENTITY::SET_ENTITY_INVINCIBLE(iLocal_84, true, 0);
	}
...
int func_226(char* sParam0, char* sParam1, int iParam2)
{
...
void func_229(var uParam0, bool bParam1, int iParam2, int iParam3)
{
	int iVar0;
...
int func_233()
{
	if ((Global_114333 == func_104() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_114334)
	{
		return 1;
	}
	return 0;
...
int func_240(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
	...
	if (!bVar0)
	{
		...
		if (!func_276(Global_114344.f_24999.f_43[iParam3]))
		{
			return 0;
		}
...
void func_245(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	func_246(func_257(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_246(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_274()) || Global_113391) || Global_33284) || func_273()) || func_19(8, -1)) || func_272()) || func_271()) || func_270()) || func_269()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_274()) || Global_33284) || func_273()) || func_19(8, -1)) || func_270()) || func_272()) || func_271()) || func_269()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_274()) || Global_113391) || Global_33284) || func_273()) || func_19(8, -1)) || func_270()) || func_272()) || func_271()) || func_269()) || Global_114344.f_7692.f_919[iVar0] == 5) || Global_44922 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_274()) || Global_113391) || Global_33284) || func_273()) || func_19(8, -1)) || func_272()) || func_271()) || func_269()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_274() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_19(8, -1)) || func_269()) || func_268()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_274()) || Global_33284) || func_273()) || func_19(8, -1)) || func_271()) || func_270()) || func_269()) || Global_114344.f_7692.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_274()) || func_271()) || Global_113391) || Global_33284) || func_273()) || Global_45590) || func_19(8, -1)) || func_270()) || func_268()) || func_269()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_274()) || Global_113391) || Global_33284) || func_273()) || func_19(8, -1)) || func_270()) || func_268()) || func_272()) || func_271()) || func_269())
						{
							return 0;
						}
						break;
...
void func_285(int iParam0)
{
	...
	if (func_233())
	{
		...
		func_288(30000);
		StringCopy(&cVar0, func_287(Global_114333, 1), 64);
		if (func_103(Global_114333) > 0)
		{
