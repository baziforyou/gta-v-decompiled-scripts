...
void __EntryFunction__()
{
	...
	fLocal_63 = 0f;
	Local_137 = { 1140.746f, 258.6841f, -52.4408f };
	iLocal_144 = -1;
	iLocal_230 = -1;
	iLocal_1667 = -1;
	iLocal_1668 = -1;
...
void func_1()
{
	...
	{
		func_13();
		MISC::SET_BIT(&(Local_2759.f_659), false);
	}
	func_2();
}
...
void func_47()
{
	...
	if (bVar0)
	{
		if (PAD::IS_CONTROL_JUST_RELEASED(0, 0) || PAD::IS_DISABLED_CONTROL_JUST_RELEASED(0, 0))
		{
			...
			MISC::CLEAR_BIT(&uLocal_1656, false);
		}
	...
	if (!BitTest(uLocal_1656, 3))
	{
		...
		if ((((bVar0 && (!BitTest(Local_2759.f_653[func_11(iLocal_2143)], func_10(iLocal_2143)) || BitTest(Local_3419[PLAYER::PLAYER_ID() /*11*/].f_10, 2))) && !BitTest(Local_3419[PLAYER::PLAYER_ID() /*11*/].f_10, 0)) && BitTest(uLocal_1656, 0)) && !(BitTest(uLocal_1656, 21) || BitTest(uLocal_1656, 22)))
		{
			if (PAD::IS_CONTROL_JUST_PRESSED(2, 201) || PAD::IS_CONTROL_JUST_PRESSED(2, 208))
			{
				...
				else if (func_197() >= (Local_231[iLocal_2143 /*21*/].f_16 * iLocal_2146))
				{
					if ((((iLocal_1660 == 4 || iLocal_1660 == 10) || iLocal_1660 == 11) || iLocal_1660 == 12) || ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), -278874898))
					{
						...
						func_194();
						MISC::CLEAR_BIT(&(Local_3419[PLAYER::PLAYER_ID() /*11*/].f_10), true);
						MISC::CLEAR_BIT(&(Local_3419[PLAYER::PLAYER_ID() /*11*/].f_10), 2);
						MISC::CLEAR_BIT(&(Local_3419[PLAYER::PLAYER_ID() /*11*/].f_10), false);
			...
			if (!BitTest(uLocal_1656, 3))
			{
				if ((((iLocal_1660 == 4 || iLocal_1660 == 10) || iLocal_1660 == 11) || iLocal_1660 == 12) || ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), -278874898))
				{
					if (PAD::IS_CONTROL_JUST_PRESSED(2, 203) && !BitTest(uLocal_1656, 27))
					{
						MISC::SET_BIT(&uLocal_1656, 30);
						func_186(1, -1, -1, -1);
						iLocal_2146++;
					...
					if (PAD::IS_CONTROL_JUST_RELEASED(2, 204) && !BitTest(uLocal_1656, 28))
					{
						MISC::SET_BIT(&uLocal_1656, 30);
						func_186(1, -1, -1, -1);
						iLocal_2146 = 5;
			...
			if (!BitTest(Local_3419[PLAYER::PLAYER_ID() /*11*/].f_10, 3))
			{
				if (((iLocal_1660 == 8 || iLocal_1660 == 14) || iLocal_1660 == 9) || iLocal_1660 == 15)
				{
					if (func_35() > 0.99f || ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), joaat("start_spin")))
					{
						...
						MISC::SET_BIT(&(Local_3419[PLAYER::PLAYER_ID() /*11*/].f_10), false);
					}
				}
				else
				{
			...
			if (!BitTest(Local_3419[PLAYER::PLAYER_ID() /*11*/].f_10, 1))
			{
				...
				if (Local_231[iLocal_2143 /*21*/] > 0)
				{
					if (func_124(Local_231[iLocal_2143 /*21*/], &iLocal_2758, 0))
					{
						...
						func_60();
						MISC::SET_BIT(&(Local_3419[PLAYER::PLAYER_ID() /*11*/].f_10), true);
						iLocal_2758 = 0;
					}
				}
				else
...
int func_70(int iParam0)
{
	...
	else if (Local_231[iLocal_2143 /*21*/].f_17 == 4)
	{
		...
		{
			func_71(0, "SLOT MACHINE RP", -1827353931, 1223799452, Global_262145.f_27460, 1, -1, 0);
		}
	}
...
bool func_140(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_158())
	{
		if (*uParam0 == 0)
		{
			...
			if (func_153(78225582, 1950528552, iVar3, iVar5, iParam2, iVar1, 0, 4, 0, 3))
			{
				if (func_153(78225582, 1845931212, iVar4, iVar5, 1, 0, 0, 4, 0, 3))
				{
					if (func_148())
					{
						*uParam0 = 1;
...
int func_153(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	bool bVar0;
	int iVar1;
	struct<4> Var2;
...
int func_155(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, var uParam5)
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	*iParam0 = 0;
	...
	{
		*iParam0 = func_156(uVar3, iParam1, -2085313189, iParam3, iParam2, 0, 1, iParam4, uParam5, 0, bVar0);
		return 1;
	}
	return 0;
}

int func_156(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, var uParam8, int iParam9, bool bParam10)
{
	int iVar0;
...
int func_159()
{
	...
	iVar1 = (Global_262145.f_26736 - func_197());
	iVar2 = func_160();
	if (iVar0 > iVar1)
	{
		iVar0 = iVar1;
...
int func_164(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	...
	MISC::CLEAR_BIT(&uLocal_1657, false);
	if (iParam1 == iParam2 && iParam2 == iParam3)
	{
		...
		{
			MISC::SET_BIT(&uLocal_1657, false);
		}
		return iVar1;
	}
	else
...
void func_186(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iLocal_2100 != iParam0)
	{
		...
		{
			case 1:
				func_193("SLOTS_HELPB", Local_231[iLocal_2143 /*21*/].f_16, Local_231[iLocal_2143 /*21*/].f_16 * 5);
				break;
					...
					if (iParam1 == 7 && iParam3 > 0)
					{
						...
						else if (Local_231[iLocal_2143 /*21*/].f_17 == 4)
						{
							...
							if (iLocal_230 == -1)
							{
								...
								func_192(&Var10, Global_262145.f_27460);
							}
							else
							{
...
int func_207(int iParam0)
{
	...
	else if ((((((((Global_262145.f_26515 || (Global_262145.f_26522 && Local_231[iParam0 /*21*/].f_17 == 1)) || (Global_262145.f_26520 && Local_231[iParam0 /*21*/].f_17 == 2)) || (Global_262145.f_26517 && Local_231[iParam0 /*21*/].f_17 == 3)) || (Global_262145.f_26518 && Local_231[iParam0 /*21*/].f_17 == 4)) || (Global_262145.f_26521 && Local_231[iParam0 /*21*/].f_17 == 5)) || (Global_262145.f_26519 && Local_231[iParam0 /*21*/].f_17 == 6)) || (Global_262145.f_26516 && Local_231[iParam0 /*21*/].f_17 == 7)) || (Global_262145.f_26523 && Local_231[iParam0 /*21*/].f_17 == 8))
	{
		...
		if (!BitTest(uLocal_1656, 0))
		{
			if (BitTest(uLocal_1656, 21) || BitTest(uLocal_1656, 22))
			{
				...
				if (func_280(0, -1, 0) && GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED(&Var0))
				{
					...
					{
						func_276("SLOTS_RULEbT");
						func_275("SLOTS_RULEb", 0, 0);
					...
					func_272(202, "SLOTS_RULEBK", -1);
					func_271(8, "SLOTS_RULENEXT", -1);
					MISC::SET_BIT(&uLocal_1656, false);
			...
			else if (func_280(0, -1, 0))
			{
				...
				if (!BitTest(Local_3419[PLAYER::PLAYER_ID() /*11*/].f_10, 0) && (((((iLocal_1660 == 4 || iLocal_1660 == 10) || iLocal_1660 == 11) || iLocal_1660 == 12) || BitTest(uLocal_1656, 31)) || ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::PLAYER_PED_ID(), -278874898)))
				{
					...
					func_272(203, "SLOTS_BET", -1);
					if (iLocal_2146 < 5)
					{
						func_272(204, "SLOTS_BETM", -1);
					}
				}
				func_272(210, "SLOTS_RULEIN", -1);
				MISC::SET_BIT(&uLocal_1656, false);
...
void func_247(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (bParam3)
	{
		...
		{
			func_263(Global_23970.f_5821 + 1, "DFLT_MNU_OPT", 0, 1, 0, 0, 0);
	...
	while (iVar5 < 2)
	{
		if (iVar5 == 1 && Global_23970.f_6331)
		{
			...
			else
			{
				...
				{
					func_258();
					func_256((((Global_23967 + fParam5) - 0.00390625f) - func_257("CM_ITEM_COUNT", Global_23970.f_6339, Global_23970.f_6340)), ((Global_23968 + fVar57) + 0.00416664f), "CM_ITEM_COUNT", Global_23970.f_6339, Global_23970.f_6340);
				}
				else if (Global_23970.f_6334 > Global_23970.f_5828)
				{
					...
					{
						func_258();
						func_256((((Global_23967 + fParam5) - 0.00390625f) - func_257("CM_ITEM_COUNT", Global_23970.f_6337, Global_23970.f_6336)), ((Global_23968 + fVar57) + 0.00416664f), "CM_ITEM_COUNT", Global_23970.f_6337, Global_23970.f_6336);
					}
				}
			}
...
void func_252(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_260(int iParam0, bool bParam1)
{
	char* sVar0[2];
	var uVar3;
	struct<13> Var19;
...
void func_267(bool bParam0, int* iParam1, int* iParam2, float fParam3)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_278(int iParam0, char* sParam1, char* sParam2)
{
	Global_23970 = iParam0;
	func_279(29, sParam1, sParam2);
}

void func_279(int iParam0, char* sParam1, char* sParam2)
{
	StringCopy(&(Global_23970.f_6623[iParam0 /*16*/]), sParam1, 64);
	StringCopy(&(Global_23970.f_7680[iParam0 /*16*/]), sParam2, 64);
}

bool func_280(char* sParam0, int iParam1, bool bParam2)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool func_302(struct<3> Param0, struct<3> Param3, bool bParam6)
{
	if (bParam6)
	{
	...
	if ((((((((((((((((func_12(PLAYER::PLAYER_ID(), 1, 1) && func_334(PLAYER::PLAYER_PED_ID()) <= 9) && !Global_2635516.f_2982) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) && !BitTest(Global_1943917.f_4, 2)) && !func_233()) && !NETWORK::IS_COMMERCE_STORE_OPEN()) && !HUD::IS_STORE_PENDING_NETWORK_SHUTDOWN_TO_OPEN()) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS()) && !func_232(1)) && !func_234()) && !func_222()) && !func_220()) && !CAM::IS_SCREEN_FADED_OUT()) && !CAM::IS_SCREEN_FADING_OUT()) && !Global_2696456.f_12) && Global_1943910 != 33)
	{
		...
		if (iLocal_2148 >= 0)
		{
			...
			if (Local_2759.f_598[iLocal_2148] == -1 && !func_327(iLocal_2148))
			{
				...
				{
					MISC::CLEAR_BIT(&uLocal_1656, true);
				}
...
int func_321()
{
	if ((func_322("SLOTS_NOMON") || func_322("SLOTS_FAILTR")) || func_322("SLOTS_USED"))
	{
		return 1;
	}
	if (BitTest(uLocal_1656, 6))
	{
		if (((((func_322("CAS_MG_CBAN") || func_322("CAS_MG_CTIME")) || func_322("CAS_MG_LOWCHIPS1")) || func_322("CAS_MG_NOCHIPS1")) || func_212("CAS_MG_MEMB2", func_213(1))) || func_322("SLOTS_REGBAN"))
		{
			return 1;
		}
	}
...
void func_324(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)
{
	int iVar0;
...
bool func_328(int iParam0, struct<3> Param1, float fParam4)
{
	return func_329(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_HEADING(iParam0), Param1, fParam4);
}

bool func_329(struct<3> Param0, float fParam3, struct<3> Param4, float fParam7)
{
	struct<3> Var0;
	float fVar3;
...
int func_332(float fParam0, float fParam1, float fParam2)
{
	float fVar0;
	float fVar1;
...
float func_333(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, int iParam6)
{
	float fVar0;
	float fVar1;
	float fVar2;
