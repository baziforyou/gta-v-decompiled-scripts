#region Local Var
	...
	var uLocal_141 = 0;
	var uLocal_142 = 0;
	struct<6> Local_143 = { 0, 0, 0, 0, 0, -1 } ;
	var uLocal_149 = 0;
	var uLocal_150 = 0;
	var uLocal_151 = 3;
	var uLocal_152 = 17;
...
void __EntryFunction__()
{
	...
	while (true)
	{
		if (iLocal_263 != Global_4718592)
		{
			func_19(&Local_143);
			iLocal_263 = Global_4718592;
			MISC::CLEAR_BIT(&(Local_143.f_4), 0);
		}
		if (func_18() == 3)
		{
			func_20();
		...
		switch (iLocal_261)
		{
			...
			case 1:
				if (Local_143.f_5 != Global_4718592)
				{
					Local_143.f_5 = Global_4718592;
					func_19(&Local_143);
				}
