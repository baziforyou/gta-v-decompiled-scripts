...
int func_7(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_8(Global_101614) && iParam1 != 0)
		{
			Global_101614 = 0;
		}
	}
...
void func_11()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_14(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_12(iVar0) && (!func_16(14) || Global_113292))
			{
...
void func_22()
{
	...
	{
		case 97:
			Local_107[0 /*3*/] = { Vector(45.5004f, -205.8167f, -1416.54f) - Local_103 };
			Local_107[1 /*3*/] = { Vector(45.5004f, -207.5375f, -1423.898f) - Local_103 };
			Local_107[2 /*3*/] = { Vector(45.5004f, -210.4254f, -1428.501f) - Local_103 };
			Local_107[3 /*3*/] = { Vector(45.5004f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-205.8167f, -210.4254f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-1416.54f, -1428.501f)) - Local_103 };
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_114344.f_2367.f_539.f_2310[0];
			StringCopy(sParam2, func_33(Global_114344.f_2367.f_539.f_2314[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_114344.f_2367.f_539.f_2310[1];
			StringCopy(sParam2, func_33(Global_114344.f_2367.f_539.f_2314[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_114344.f_2367.f_539.f_2310[2];
			StringCopy(sParam2, func_33(Global_114344.f_2367.f_539.f_2314[2]), 32);
			return 1;
			break;
