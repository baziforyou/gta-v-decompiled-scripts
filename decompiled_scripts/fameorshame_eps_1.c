...
int func_16(bool bParam0, bool bParam1, var uParam2, bool bParam3)
{
	int iVar0;
...
void func_25(var uParam0, struct<3> Param1, struct<3> Param4, int iParam7, float fParam8, float fParam9)
{
	uParam0->f_1 = { Param1 };
	uParam0->f_4 = { Param4 };
	uParam0->f_7 = iParam7;
...
void func_26(var uParam0, int iParam1, struct<3> Param2, struct<3> Param5, int iParam8, int iParam9, int iParam10)
{
...
void func_27(var uParam0, var uParam1, struct<3> Param2, struct<3> Param5, var uParam8, var uParam9, var uParam10)
{
	*uParam0 = { Param2 };
	uParam0->f_3 = { Param5 };
	uParam0->f_6 = uParam8;
