	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113431[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_296(&(Global_113431[Var0.f_0 /*10*/].f_9));
			}
		}
		func_284(&Var0, 1);
	}
...
int func_158(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
int func_169(int iParam0)
{
	...
	iVar0 = func_171(&(Global_113431[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
{
	return func_174(iParam0, Global_44375);
}
...
int func_180(struct<3> Param0, bool bParam3)
{
	int iVar0;
...
int func_217(var uParam0, bool bParam1)
{
	...
	if ((func_254(*uParam0) || func_252(*uParam0)) || Global_79990 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
{
	if ((func_253() && Global_101893.f_11 == 6) && iParam0 == func_177(&(Global_101893.f_3), 0))
	{
		return 1;
	}
	return 0;
...
void func_257(int* iParam0, struct<3> Param1, float fParam4)
{
...
int func_264(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
...
int func_265(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
int func_281(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	int iVar0;
...
int func_282(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
...
int func_283(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
