				...
				case 3:
					...
					else
					{
						...
						if (!func_75(3) && !Global_101927)
						{
							...
							{
								if ((!func_89(uLocal_92, 1) || !ENTITY::DOES_ENTITY_EXIST(func_74())) && !Global_101927)
								{
									func_82(10);
									break;
								}
							...
							if (iLocal_118 > iLocal_119)
							{
								if (iVar3 < iLocal_118 && iVar3 >= iLocal_119)
								{
									...
									if (fLocal_91 < ((fLocal_115 * fLocal_115) + 4f))
									{
										...
										{
											func_47("MG_NA_TIME", iLocal_118, iLocal_119);
...
void func_49()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_52(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_50(iVar0) && (!func_77(14) || Global_113292))
			{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_71()) || Global_33284) || func_70()) || func_56(8, -1)) || func_67()) || func_69()) || func_68()) || func_58()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_71()) || Global_113391) || Global_33284) || func_70()) || func_56(8, -1)) || func_69()) || func_68()) || func_58()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_71() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_56(8, -1)) || func_58()) || func_66()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_79()
{
	if (bLocal_123)
	{
		...
		if (!iLocal_125)
		{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_121))
			{
				iLocal_121 = VEHICLE::CREATE_VEHICLE(joaat("blazer"), -1707.434f, 4666.563f, 22.1095f, 323.2491f, true, true, false);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_122))
			{
				iLocal_122 = VEHICLE::CREATE_VEHICLE(joaat("journey"), -1702.695f, 4666.941f, 22.7091f, 80.03f, true, true, false);
