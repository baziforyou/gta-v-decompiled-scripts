...
void func_1()
{
	if (!func_3())
	{
		if (MISC::ARE_STRINGS_EQUAL("NULL", &Global_113400))
		{
			func_2(0);
		}
		else if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(MISC::GET_HASH_KEY(&Global_113400)) == 0)
		{
			func_2(0);
		}
	}
...
void func_5()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_113376))
	{
		...
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_113376, &cLocal_268, "Aknowledge_R", 3))
			{
				ENTITY::STOP_ENTITY_ANIM(Global_113376, "Aknowledge_R", &cLocal_268, -4f);
			}
			else if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_113376, &cLocal_268, "Aknowledge_L", 3))
			{
				ENTITY::STOP_ENTITY_ANIM(Global_113376, "Aknowledge_L", &cLocal_268, -4f);
			}
		}
	}
	if (iLocal_52 == 0)
...
void func_16()
{
	if (func_22(&Global_113375, iLocal_98, iLocal_97))
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_113375, false))
		{
			if (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Global_113375))
			{
				func_21();
				...
				func_20(&Global_113375, iLocal_277);
				if (!PED::IS_PED_INJURED(Global_113376) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_113375, false))
				{
					if (PED::IS_PED_SITTING_IN_VEHICLE(Global_113376, Global_113375))
					{
						if (!func_19(Global_113376, joaat("script_task_vehicle_temp_action")))
						{
...
void func_29()
{
	...
	if (func_25(&iLocal_275))
	{
		if (!iLocal_87)
		{
			if (iLocal_275 == Global_113375 && iLocal_53 == 4)
			{
				if (!HUD::IS_HELP_MESSAGE_ON_SCREEN())
				{
					if (!func_7("TX_H02"))
					{
						if (Global_114344.f_10053.f_121 < 5)
						{
							func_30("TX_H02", -1);
							Global_114344.f_10053.f_121++;
						}
						iLocal_87 = 1;
					}
				}
				...
				if (func_28(&iLocal_275, &iVar1, 0))
				{
					...
					if (!PED::IS_PED_INJURED(Global_113376) && VEHICLE::IS_VEHICLE_DRIVEABLE(Global_113375, false))
					{
						if (PED::IS_PED_SITTING_IN_VEHICLE(Global_113376, Global_113375))
						{
							if (!func_19(Global_113376, joaat("script_task_vehicle_temp_action")))
							{
								TASK::TASK_VEHICLE_TEMP_ACTION(Global_113376, Global_113375, 1, 10000);
							}
						}
					}
					iLocal_87 = 0;
...
void func_32()
{
	if (func_42(&Global_113375, &Global_113376, iLocal_98, iLocal_97))
	{
		if (!func_36())
		{
			if (!func_19(Global_113376, joaat("script_task_vehicle_temp_action")))
...
int func_36()
{
	...
	if (iLocal_53 == 4)
	{
		if (Global_113412 == -1 || Global_113412 == 0)
		{
			Global_113412 = MISC::GET_GAME_TIMER();
		}
		else if (func_41(Global_113412, 30000))
		{
	...
	if (func_39(Global_113375))
	{
		...
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Global_113375, PLAYER::PLAYER_PED_ID(), true))
		{
			return 1;
		}
		...
		{
			if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Global_113375) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Global_113375))
			{
				return 1;
			}
	...
	if (func_37(Global_113376))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Global_113376, PLAYER::PLAYER_PED_ID(), true))
		{
			return 1;
		}
	}
...
int func_44()
{
	...
	if (!Global_45589 && PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
	{
		return 0;
	}
	...
	if (func_42(&Global_113375, &Global_113376, iLocal_98, iLocal_97))
	{
		...
		if (bVar0)
		{
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_268))
			{
				...
				TASK::TASK_VEHICLE_MISSION(0, Global_113375, Global_113375, 22, 12f, 262275, 3f, 3f, true);
				TASK::TASK_VEHICLE_MISSION(0, Global_113375, Global_113375, 5, 12f, 262275, 3f, 3f, true);
				TASK::CLOSE_SEQUENCE_TASK(iVar2);
				TASK::TASK_PERFORM_SEQUENCE(Global_113376, iVar2);
...
void func_50()
{
	...
	if (func_39(Global_113375))
	{
		if (!HUD::DOES_BLIP_EXIST(iLocal_91))
		{
			iLocal_91 = HUD::ADD_BLIP_FOR_ENTITY(Global_113375);
			HUD::SET_BLIP_SPRITE(iLocal_91, 198);
			HUD::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_91, "TXM_BLIP");
			...
			if (func_44())
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_268))
				{
					if (((!ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_268, "HAIL_TAXI", 3) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_268, "FP_HAIL_TAXI", 3)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_268, "FUCK_U", 3)) && !ENTITY::IS_ENTITY_PLAYING_ANIM(PLAYER::PLAYER_PED_ID(), &cLocal_268, "FORGET_IT", 3))
					{
						...
						if (iLocal_93 == -1)
						{
							func_62(&iLocal_93, 0, "TXM_H01", 1, 0, 0, 0);
						}
						if (func_61(iLocal_93, 1))
						{
							...
							else
							{
								...
								{
									iLocal_276 = 0;
									TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Global_113375, 5000, 0, 2);
									Global_113412 = MISC::GET_GAME_TIMER();
									if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_113375, false))
									{
										if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
										{
											CAM::SET_GAMEPLAY_VEHICLE_HINT(Global_113375, 0f, 0f, 0f, true, 4000, 2000, 2000);
											iLocal_86 = 1;
										}
									}
									Global_114344.f_10053.f_120 = 1;
	...
	if (func_67())
	{
		if (iLocal_52 == 0 && iLocal_53 != 4)
		{
			...
			if (func_28(&Local_54, &(Local_54.f_1), 0))
			{
				...
				if (func_39(Global_113375))
				{
					VEHICLE::START_VEHICLE_HORN(Global_113375, 2500, MISC::GET_HASH_KEY("NORMAL"), false);
				}
				if (ENTITY::DOES_ENTITY_EXIST(Global_113376))
				{
					if (!PED::IS_PED_INJURED(Global_113376))
					{
						TASK::TASK_LOOK_AT_ENTITY(Global_113376, PLAYER::PLAYER_PED_ID(), 3000, 0, 2);
						TASK::TASK_LOOK_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Global_113376, 3000, 0, 2);
					}
				}
				func_50();
				iLocal_53 = 4;
...
void func_84()
{
	...
	{
		if (func_88(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_87(PLAYER::PLAYER_PED_ID());
			if (func_86(iVar0) && (!func_85(14) || Global_113292))
			{
				if (Global_114344.f_2367.f_539.f_4321 != iVar0 && func_86(Global_114344.f_2367.f_539.f_4321))
				{
...
int func_137(struct<3> Param0, int iParam3)
{
	if (iParam3 != -1)
	{
		...
		{
			return func_137(Param0, Global_44376[iParam3 /*5*/].f_4);
		}
	}
	return 0;
}
