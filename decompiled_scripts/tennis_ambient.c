...
void __EntryFunction__()
{
	...
	if (((func_340(10) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("tennis")) == 0) || Global_98796) && !ScriptParam_0.f_1)
	{
...
void func_42()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_46(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_44(iVar0) && (!func_43(14) || Global_113292))
			{
...
Vector3 func_90(var uParam0, struct<3> Param1, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, int iParam11, var uParam12)
{
	...
	while (iVar1 < 180)
	{
		func_281(uParam0, &Param1, &uParam4, &uParam7, &uParam10, &iParam11, &uParam12, &iVar0, 0, 0.03333334f, 0, 0.1f, 0);
		if (iVar0 > 0)
		{
			return Param1;
		}
...
void func_110(var uParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, int iParam10)
{
...
void func_111(int iParam0, char* sParam1, char* sParam2, int iParam3, bool bParam4)
{
...
int func_140(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	if (iVar0 == 72)
	{
		iVar19 = func_144(uParam0, &Var20, &Var23, &Local_209, &Local_215, &Local_218, 0, &fVar29, &fVar30, &uVar26);
		if (iVar19 == 0)
		{
	...
	{
		iVar19 = func_144(uParam0, &Var20, &Var23, &Local_197, &Local_203, &Local_206, 1, &fVar29, &fVar30, &uVar26);
		if (iVar19 == 0)
		{
			func_143(uParam0, 0.5f);
			func_142(uParam0, 1f);
...
int func_145(var uParam0, var uParam1, var uParam2, struct<3> Param3, var uParam6)
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
				...
				if ((uParam3[iVar32 /*12*/])->f_1 >= 0f)
				{
					...
					if (iVar3 < (*uParam4 - 2) && iVar3 >= 0)
					{
						if (iVar24 == 0 && (iVar32 == 72 || iVar32 == 73))
						{
							...
							if (iVar32 == 72)
							{
								iVar37 = func_144(uParam0, uParam4[8 /*3*/], uParam4[9 /*3*/], &Local_209, &Local_215, &Local_218, 0, &fVar38, &fVar39, &Var28);
							}
							else
							{
								iVar37 = func_144(uParam0, uParam4[8 /*3*/], uParam4[9 /*3*/], &Local_197, &Local_203, &Local_206, 1, &fVar38, &fVar39, &Var28);
							}
							if (iVar37 != 0)
							{
...
int func_153(var uParam0, struct<3> Param1, bool bParam4)
{
	if (!bParam4)
	{
		return 0;
...
int func_166(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, struct<3> Param6, bool bParam9)
{
...
void func_171(var uParam0, struct<3> Param1, var uParam4, var uParam5, var uParam6, var uParam7)
{
	uParam0->f_78 = { Param1 };
...
float func_190(struct<2> Param0, var uParam2, struct<2> Param3, Vector3 vParam5)
{
...
void func_264(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	if (!PED::IS_PED_INJURED(func_267(uParam0[iParam1 /*94*/])) && !PED::IS_PED_INJURED(func_267(uParam0[iParam2 /*94*/])))
	{
		...
		else
		{
			if (!bParam4)
			{
				ENTITY::ATTACH_ENTITY_TO_ENTITY((uParam0[iParam1 /*94*/])->f_33, func_267(uParam0[iParam1 /*94*/]), PED::GET_PED_BONE_INDEX(func_267(uParam0[iParam1 /*94*/]), 28422), Local_191, Local_194, false, false, false, false, 2, true, 0);
			}
			ENTITY::ATTACH_ENTITY_TO_ENTITY((uParam0[iParam2 /*94*/])->f_33, func_267(uParam0[iParam2 /*94*/]), PED::GET_PED_BONE_INDEX(func_267(uParam0[iParam2 /*94*/]), 28422), Local_191, Local_194, false, false, false, false, 2, true, 0);
		}
	}
}
...
Vector3 func_272(var uParam0, int iParam1, struct<3> Param2, struct<3> Param5, bool bParam8, int iParam9)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
Vector3 func_282(struct<3> Param0, float fParam3)
{
	struct<3> Var0;
	float fVar3;
	struct<3> Var4;
...
void func_315(var uParam0, struct<3> Param1, struct<3> Param4, struct<3> Param7, struct<3> Param10)
{
...
void func_320(var uParam0, int iParam1, int iParam2, struct<3> Param3, struct<3> Param6)
{
	uParam0->f_36 = 75;
	uParam0->f_1 = iParam1;
...
void func_330()
{
	...
	if (Global_114344.f_9089 || func_339(0))
	{
		if (!func_338())
		{
			iVar0 = func_337();
...
int func_332(int iParam0)
{
	...
	func_333(&(Global_114344.f_2367.f_539), iVar1);
...
void func_333(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_335(Global_114344.f_18537[iVar0], &Var2, &fVar5))
			{
