	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113431[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_294(&(Global_113431[Var0.f_0 /*10*/].f_9));
			}
		}
		func_282(&Var0, 1);
	}
...
int func_209(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
...
int func_213(var uParam0, bool bParam1)
{
	...
	if ((func_250(*uParam0) || func_248(*uParam0)) || Global_79990 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
int func_228(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_232(struct<3> Param0, struct<3> Param3)
{
	return (((Param0.f_0 * Param3.f_0) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_240(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
{
	if ((func_249() && Global_101893.f_11 == 6) && iParam0 == func_179(&(Global_101893.f_3), 0))
	{
		return 1;
	}
	return 0;
...
void func_257(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_258(iParam0);
...
int func_259(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
...
int func_260(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
int func_280(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
...
int func_281(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
