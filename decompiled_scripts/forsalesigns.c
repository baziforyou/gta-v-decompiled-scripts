...
void func_1()
{
	...
	while (bVar0 < 15)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_208[bVar0 /*11*/]))
		{
			...
			{
				MISC::SET_BIT(&(Global_114344.f_10053.f_108), bVar0);
				func_19(bVar0);
		...
		else if (!BitTest(Global_114344.f_10053.f_108, bVar0))
		{
...
int func_2(int iParam0)
{
	...
	else
	{
		...
		{
			if (!BitTest(Global_114344.f_10053.f_108, func_3(func_4(iParam0), iVar0)))
			{
				return 0;
			}
			iVar0++;
...
int func_5(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (BitTest(Global_114344.f_10053.f_108, func_3(func_4(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
bool func_13(int iParam0, struct<3> Param1, float fParam4, bool bParam5)
{
...
void func_38()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_41(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_39(iVar0) && (!func_43(14) || Global_113292))
			{
...
void func_51()
{
	...
	if (!func_2(2))
	{
		...
		Local_208[3 /*11*/].f_3 = { -1632.833f, -413.8573f, 39.9441f };
		Local_208[3 /*11*/].f_9 = 321.5f;
		Local_208[4 /*11*/].f_3 = { -1765.678f, -423.9763f, 41.5f };
		...
		Local_208[7 /*11*/].f_3 = { -493.083f, 588.6333f, 122.485f };
		...
		Local_208[12 /*11*/].f_3 = { -1253.439f, 491.05f, 94.3706f };
...
void func_66()
{
	...
	{
		func_68(13, SYSTEM::FLOOR(Global_114344.f_10198.f_3853));
	}
