...
void __EntryFunction__()
{
	...
	while (iVar0 < 5)
	{
		...
		MISC::SET_BIT(&(Global_114344.f_18578[(iLocal_28 + iVar0) /*6*/]), 3);
		iVar0++;
	}
	func_19(1);
	while (true)
...
bool func_1()
{
	return (((func_9(9) || Global_33284) || func_2() != 2) || Global_113431[56 /*10*/].f_3);
}
...
{
	return func_11(iParam0, Global_44375);
}
...
void func_19(bool bParam0)
{
	...
	while (iVar0 < 5)
	{
		...
		func_23(iVar1, 1);
		func_22(iVar1, 44);
		if (((Global_114344.f_2356[iVar0 /*2*/] >= 1 || func_36(108) == 1) || func_21((iLocal_27 + iVar0), 0)) || BitTest(Global_114344.f_18578[(iLocal_28 + iVar0) /*6*/], 3))
		{
			func_20(iVar1, 1);
		}
		iVar0++;
...
void func_28()
{
	...
	{
		func_32(13, SYSTEM::FLOOR(Global_114344.f_10198.f_3853));
	}
