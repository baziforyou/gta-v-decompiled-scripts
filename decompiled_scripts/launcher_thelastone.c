...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113431[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_280(&(Global_113431[Var0.f_0 /*10*/].f_9));
			}
		}
		func_267(&Var0, 1);
	}
	...
	while (true)
	{
		...
		func_196(&Var0, Var61, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
		if (func_181(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_196(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	var uVar0;
...
float func_202(int iParam0, struct<3> Param1, bool bParam4)
{
	struct<3> Var0;
...
void func_203(int iParam0, var uParam1, char* sParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_278(int* iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
