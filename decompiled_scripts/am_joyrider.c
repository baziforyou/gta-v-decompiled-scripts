	...
	if ((!NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_60.f_3) && func_37(Local_60.f_5)) && NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(Local_60.f_2))
	{
		if (func_4(Local_60.f_2))
		{
			if (func_11(&(Local_60.f_3), Local_60.f_2, 22, Local_60.f_5, -1, 1, 1, 1))
			{
				...
				if (func_10())
				{
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(NETWORK::NET_TO_PED(Local_60.f_3), Global_1837326);
				}
				else
				{
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(NETWORK::NET_TO_PED(Local_60.f_3), Global_1837329);
				}
				...
				ENTITY::SET_ENTITY_HEALTH(NETWORK::NET_TO_PED(Local_60.f_3), SYSTEM::ROUND((200f * Global_262145.f_156)), 0, 0);
...
bool func_16(int iParam0, float* fParam1)
{
	...
	if (!bVar0)
	{
		if (VEHICLE::GENERATE_VEHICLE_CREATION_POS_FROM_PATHS(&(Local_60.f_6), iParam0, &uVar2, 0f, 180f, 40f, 0, 1, 1))
		{
			...
			{
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(-1367.557f, -3220.598f, 12.9448f, Local_60.f_6, true) >= 600f && MISC::GET_DISTANCE_BETWEEN_COORDS(750f, -3200f, 6f, Local_60.f_6, true) >= 700f)
				{
	...
	while (iVar0 < 32)
	{
		...
		if (func_72(iVar1, 1, 1))
		{
			if (!func_20(iVar1, 0) && NETWORK::NETWORK_ARE_PLAYERS_IN_SAME_TUTORIAL_SESSION(PLAYER::PLAYER_ID(), iVar1))
			{
				...
				{
					if ((func_19(iVar1) || !bParam10) && !Global_2658016[iVar1 /*467*/].f_273)
					{
						fVar2 = fParam6;
						if (fParam9 > 0f)
						{
...
Vector3 func_24(int iParam0)
{
	...
	iVar0 = iParam0;
	if ((func_28() && Global_1845225[iVar0 /*874*/].f_856) && !func_27(Global_1845225[iVar0 /*874*/].f_857))
	{
...
int func_29(struct<3> Param0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, int iParam8, var uParam9, int iParam10)
{
	int iVar0;
	int iVar1;
...
int func_30(int iParam0)
{
	...
	Global_2707872 = { func_34(iParam0) };
...
int func_35(int iParam0, int iParam1)
{
	...
	{
		Global_2707872 = { func_34(iParam0) };
		Global_2707885 = { func_34(iParam1) };
	...
	if (!BitTest(Local_72[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1, 0))
	{
		if (func_4(Local_60.f_2) && !func_3(Local_60.f_3))
		{
			...
			if (iVar0 < 200)
			{
				...
				MISC::SET_BIT(&(Local_72[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1), false);
			}
			else if (fVar1 < 3f)
			{
...
void func_64(struct<21> Param0)
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
		{
			...
			{
				Local_60.f_4 = Global_2740054.f_4521;
...
void func_68(int iParam0, struct<17> Param1, var uParam18, var uParam19, var uParam20, var uParam21)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_61();
