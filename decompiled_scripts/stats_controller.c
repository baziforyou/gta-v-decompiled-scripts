...
int func_24(bool bParam0, int iParam1)
{
	switch (bParam0)
	{
		case 5:
			if (iParam1 > -1)
			{
				if (Global_1673655.f_137[iParam1])
				{
					return 1;
				}
				if (Global_1673655.f_170[iParam1])
				{
					return 1;
				}
			}
		...
		default:
			if (BitTest(Global_1673655.f_1046, bParam0))
			{
				return 1;
			}
			if (BitTest(Global_1673655.f_1047, bParam0))
			{
				return 1;
			}
			break;
...
int func_60(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	switch (iParam1)
	{
		...
		case 1:
			...
			if (iParam0 == 3)
			{
				fVar0 = (fVar0 + ((4f * Global_262145.f_23918) * IntToFloat(func_73(7237, -1))));
			}
			if (iParam0 == 3)
			{
				fVar0 = (fVar0 * 0.25f);
...
void func_100(int iParam0)
{
	...
	func_101(&(Global_1686279[iVar32 /*5*/]));
