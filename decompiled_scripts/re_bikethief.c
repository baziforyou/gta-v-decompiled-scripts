...
int func_30(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	else
	{
		...
		iVar20 = 0;
		func_36(&iVar20);
		iVar21 = func_35(Var10, Global_114344.f_7692.f_765[iVar20 /*10*/]);
		if (iVar21 == 2)
		{
			func_33(Global_114344.f_7692.f_765[iVar20 /*10*/]);
		...
		else if (iVar21 == 1)
		{
			...
			{
				if (!func_31(Global_114344.f_7692.f_765[iVar20 /*10*/]))
				{
					Global_114344.f_7692.f_765[iVar20 /*10*/] = { Var10 };
					func_32(&Var10);
					return 1;
...
void func_36(int iParam0)
{
	...
	*iParam0 = 0;
	...
	{
		if (func_35(Global_114344.f_7692.f_765[iVar0 /*10*/], Global_114344.f_7692.f_765[*iParam0 /*10*/]) == 0)
		{
			*iParam0 = iVar0;
		}
		iVar0++;
...
void func_41()
{
	...
	{
		func_43(13, SYSTEM::FLOOR(Global_114344.f_10198.f_3853));
	}
...
int func_83(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
void func_96(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_107()
{
	if (((((((((iLocal_123 < 5 && !func_25()) && func_65(iLocal_89)) && func_65(iLocal_90)) && func_74(iLocal_91)) && PED::IS_PED_IN_VEHICLE(iLocal_89, iLocal_91, false)) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_89, 13f, 13f, 13f, false, true, 0)) && !ENTITY::IS_ENTITY_AT_ENTITY(iLocal_90, iLocal_89, 13f, 13f, 13f, false, true, 0)) && (MISC::GET_GAME_TIMER() - iLocal_124) > 15000) && func_2(&uLocal_132, "REBTHAU", sLocal_302, 4, 0, 0, 0))
	{
		...
		{
			TASK::TASK_DRIVE_BY(iLocal_89, PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 15f, 50, true, -753768974);
		}
...
int func_121(char* sParam0)
{
	if (!func_122(1, 1, 0))
	{
		if ((!MISC::IS_STRING_NULL_OR_EMPTY(sParam0) && func_101(sParam0)) || func_101("CMN_HINT"))
		{
			HUD::CLEAR_HELP(true);
		}
		return 0;
...
int func_122(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_129() || func_128(Global_4718592.f_190775)) || func_127())
	{
...
int func_123(int iParam0)
{
	if (iParam0 != func_8())
	{
		...
		else if ((Global_1575086 && iParam0 == PLAYER::PLAYER_ID()) && func_124(iParam0, 1, 0))
		{
			return Global_2658016[iParam0 /*467*/].f_324.f_8 != -1;
		}
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_89))
	{
		...
		else if (func_154())
		{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_91, false) && !PED::IS_PED_INJURED(iLocal_89))
			{
				if (bLocal_315 == 2)
				{
					TASK::TASK_ENTER_VEHICLE(iLocal_89, iLocal_91, 20000, -1, 1073741824, 1, 0);
				}
				else
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_93);
					TASK::TASK_ENTER_VEHICLE(0, iLocal_91, 20000, -1, 1073741824, 1, 0);
...
int func_144(int iParam0)
{
	if (func_147())
	{
		...
		if (func_47(Global_114333))
		{
			func_145(0);
		}
		HUD::SET_MISSION_NAME(true, "RE_TITLE");
		if (iParam0 && func_47(Global_114333))
		{
...
int func_147()
{
	switch (func_148(&Global_33341, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
	...
	if (iLocal_116 == 0)
	{
		switch (bLocal_315)
		{
			case 1:
				...
				fLocal_110 = 248.5f;
				Local_103 = { 439.054f, -1920.145f, 23.5581f };
			...
			case 3:
				...
				Local_103 = { -1934.785f, 253.2105f, 83.8164f };
...
int func_186(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_218()) || Global_113391) || Global_33284) || func_217()) || func_22(8, -1)) || func_216()) || func_215()) || func_214()) || func_213()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_218()) || Global_33284) || func_217()) || func_22(8, -1)) || func_214()) || func_216()) || func_215()) || func_213()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_218()) || Global_113391) || Global_33284) || func_217()) || func_22(8, -1)) || func_214()) || func_216()) || func_215()) || func_213()) || Global_114344.f_7692.f_919[iVar0] == 5) || Global_44922 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_218()) || Global_113391) || Global_33284) || func_217()) || func_22(8, -1)) || func_216()) || func_215()) || func_213()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_218() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_22(8, -1)) || func_213()) || func_212()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_218()) || Global_33284) || func_217()) || func_22(8, -1)) || func_215()) || func_214()) || func_213()) || Global_114344.f_7692.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_218()) || func_215()) || Global_113391) || Global_33284) || func_217()) || Global_45590) || func_22(8, -1)) || func_214()) || func_212()) || func_213()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_218()) || Global_113391) || Global_33284) || func_217()) || func_22(8, -1)) || func_214()) || func_212()) || func_216()) || func_215()) || func_213())
						{
							return 0;
						}
						break;
...
float func_226(int iParam0, struct<3> Param1, bool bParam4)
{
	struct<3> Var0;
...
void func_230(int iParam0)
{
	...
	if (func_241())
	{
		...
		func_233(30000);
		StringCopy(&cVar0, func_232(Global_114333, 1), 64);
		if (func_55(Global_114333) > 0)
		{
...
int func_241()
{
	if ((Global_114333 == func_56() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_114334)
	{
		return 1;
	}
	return 0;
