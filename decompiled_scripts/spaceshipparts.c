...
void func_5()
{
	...
	{
		if (func_9(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_8(PLAYER::PLAYER_PED_ID());
			if (func_7(iVar0) && (!func_6(14) || Global_113292))
			{
				if (Global_114344.f_2367.f_539.f_4321 != iVar0 && func_7(Global_114344.f_2367.f_539.f_4321))
				{
...
int func_16(var uParam0, int iParam1)
{
	...
	if (!func_6(14) && !CAM::IS_SCREEN_FADED_OUT())
	{
		...
		if (!Global_80005)
		{
			func_17(&(uParam0->f_11), &(uParam0->f_12), &(uParam0->f_9), 0, &iLocal_605, &iLocal_607, "SSHIP_TITLE", "SSHIP_COLLECT");
		}
		if (!bLocal_606)
		{
...
int func_19(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (BitTest(Global_114344.f_10053.f_108, func_23(func_24(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
void func_50()
{
	...
	iLocal_605 = 0;
	Global_114344.f_10053.f_125.f_2 = 1;
	iVar0 = 0;
	while (iVar0 < 50)
	{
...
void func_53()
{
	...
	Global_114344.f_10053.f_125.f_2 = 0;
	iVar0 = 0;
