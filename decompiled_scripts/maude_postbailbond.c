...
void func_14(int iParam0, char* sParam1, char* sParam2, int iParam3, bool bParam4)
{
...
char* func_21()
{
	if (BitTest(Global_114344.f_24990, 3))
	{
		return "BB4_loiter";
	}
	else if (BitTest(Global_114344.f_24990, 2))
	{
		return "BB3_loiter";
	}
	else if (BitTest(Global_114344.f_24990, 1))
	{
		return "BB2_loiter";
	}
	else if (BitTest(Global_114344.f_24990, 0))
	{
		return "BB1_loiter";
	}
	return "MAUDE_loiter";
