		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_47[0]) && !ENTITY::IS_ENTITY_DEAD(iLocal_47[0], false))
		{
			if (ENTITY::IS_ENTITY_IN_AIR(iLocal_47[0]))
			{
				if (!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_47[0]))
				{
					...
					{
						TASK::TASK_PLANE_MISSION(iLocal_53[0], iLocal_47[0], 0, 0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 8, 50f, -1f, 90f, 1.401298E-43f, 7.006492E-44f, true);
					}
				}
				else if (bParam0)
				{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_47[2]) && !ENTITY::IS_ENTITY_DEAD(iLocal_47[2], false))
		{
			if (ENTITY::IS_ENTITY_IN_AIR(iLocal_47[2]))
			{
				if (!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_47[2]))
				{
					...
					{
						TASK::TASK_PLANE_MISSION(iLocal_53[2], iLocal_47[2], 0, 0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 8, 50f, -1f, 90f, 1.401298E-43f, 7.006492E-44f, true);
					}
				}
				else if (bParam0)
				{
...
void func_4()
{
	...
	{
		case 0:
			Local_59[0 /*3*/] = { -1542.113f, -3023.802f, 23.2538f };
			Local_59[1 /*3*/] = { -3089.888f, -1960.075f, 313.559f };
			Local_59[2 /*3*/] = { -1037.638f, -3316.12f, 23.2475f };
			Local_59[3 /*3*/] = { 451.174f, -4009.46f, 135.1171f };
			Local_72 = { -1612.174f, -2688.442f, 12.9444f };
	...
	switch (iLocal_81)
	{
		...
		case 2:
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_52) && !ENTITY::IS_ENTITY_DEAD(iLocal_52, false))
			{
				if (!VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_52))
				{
					if ((ENTITY::IS_ENTITY_OCCLUDED(iLocal_52) && !CAM::IS_SPHERE_VISIBLE(-1602.086f, -2674.039f, 12.9444f, 50f)) && SYSTEM::VDIST2(Var0, ENTITY::GET_ENTITY_COORDS(iLocal_52, true)) > 62500f)
					{
						iLocal_81 = 1;
					}
				}
