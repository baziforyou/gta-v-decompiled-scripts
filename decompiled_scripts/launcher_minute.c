...
int func_204(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)
{
	var uVar0;
...
int func_219(struct<2> Param0, float fParam2, struct<2> Param3, Vector3 vParam5, float fParam6)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
{
	if ((func_255() && Global_101893.f_11 == 6) && iParam0 == func_179(&(Global_101893.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_282(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	int iVar0;
...
int func_283(int iParam0, struct<3> Param1, float fParam4, var uParam5)
{
	int iVar0;
	struct<7> Var1;
...
int func_284(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
