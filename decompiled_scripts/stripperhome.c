...
int func_12()
{
	...
	if (func_270(uLocal_331, 8192))
	{
		...
		if (ENTITY::IS_ENTITY_AT_COORD(iLocal_272[0], 96.8033f, -1287.597f, 28.2688f, 5f, 5f, 2f, false, true, 1) || func_26(PLAYER::PLAYER_PED_ID(), 96.8033f, -1287.597f, 28.2688f, 1) > 100f)
		{
...
void func_30()
{
	...
	{
		func_31(0, 0, 0);
		iLocal_282[0] = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", 90.1007f, -1281.573f, 28.6661f, 2.4422f, 0f, -113.4013f, 45f, true, 2);
		CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
	}
}

void func_31(int iParam0, bool bParam1, int iParam2)
{
...
int func_60(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
int func_64(struct<3> Param0, bool bParam3)
{
	int iVar0;
...
void func_68(int iParam0)
{
	...
	{
		case 0:
			func_86("SCLUB_HOME_D", uLocal_74[0]);
		...
		case 1:
			HUD::CLEAR_PRINTS();
			func_69("SCLUB_HOME_A", uLocal_74[0], 0);
			iLocal_72 = 5;
			break;
		...
		case 4:
			func_86("SCLUB_HOME_D3", uLocal_74[0]);
			iLocal_72 = 6;
			break;
		
		case 3:
			if (func_26(iLocal_272[0], 92.5861f, -1282.86f, 28.2548f, 1) < 10f)
			{
				iLocal_72 = 5;
			}
			else
...
void func_71(char* sParam0, char* sParam1, int iParam2)
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(sParam1);
...
bool func_72(char* sParam0, char* sParam1)
{
...
void func_74(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		func_28(&(Global_114344.f_243[func_77() /*53*/].f_2[iParam0 /*5*/].f_3), 2);
	}
	else
	{
		func_75(&(Global_114344.f_243[func_77() /*53*/].f_2[iParam0 /*5*/].f_3), 2);
	}
}
...
void func_80()
{
	...
	{
		if (func_84(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_83(PLAYER::PLAYER_PED_ID());
			if (func_82(iVar0) && (!func_81(14) || Global_113292))
			{
				if (Global_114344.f_2367.f_539.f_4321 != iVar0 && func_82(Global_114344.f_2367.f_539.f_4321))
				{
...
void func_87(char* sParam0, char* sParam1, int iParam2, int iParam3)
{
	iParam3 = iParam3;
...
{
	Global_114344.f_243[func_77() /*53*/].f_2[iParam0 /*5*/] = iParam1;
}

int func_91(int iParam0)
{
	return Global_114344.f_243[func_77() /*53*/].f_2[iParam0 /*5*/];
}
...
void func_93(bool bParam0)
{
	switch (uLocal_74[0])
	{
		...
		case 7:
			if (bParam0)
			{
				func_86("SCLUB_HOME_GO", uLocal_74[0]);
			}
			else
			{
		...
		case 13:
			if (!CAM::IS_SCREEN_FADING_OUT() && func_202(&iLocal_253) >= 1f)
			{
				...
				if (!func_140(uLocal_74[0], -1))
				{
					if (uLocal_74[0] == 5)
					{
						func_69("SCLUB_PHON_HELP_ALT", uLocal_74[0], 0);
					}
					else
					{
						func_69("SCLUB_PHON_HELP", uLocal_74[0], 0);
					}
				...
				if (iVar2 <= 2)
				{
					...
					func_111(-384575792, iVar3, iVar4, 3, func_115(), func_114(uLocal_74[0]), 60000, 10000, -1, 0, -1, 0, 1);
				}
				func_40();
			}
			break;
...
{
	return Global_114344.f_243[func_77() /*53*/].f_2[iParam0 /*5*/].f_2;
}
...
void func_119(int iParam0)
{
	...
	Global_114344.f_243[func_77() /*53*/].f_2[iParam0 /*5*/].f_2++;
}

void func_120(int iParam0, int iParam1)
{
	Global_114344.f_243[func_77() /*53*/].f_2[iParam0 /*5*/].f_2 = iParam1;
}
...
void func_122(bool bParam0, int iParam1)
{
	...
	if (Global_120[bParam0 /*10*/].f_8 != 187)
	{
		if (iParam1 > 3)
		{
		}
...
void func_131(bool bParam0, int iParam1, bool bParam2)
{
	...
	if (Global_120[bParam0 /*10*/].f_8 != 187)
	{
		...
		else
		{
			...
			if (bParam0 == 172 && !BitTest(Global_2740054.f_7024, 4))
			{
				bParam2 = false;
			}
			if (bParam0 == 171 && !BitTest(Global_2740054.f_7024, 3))
			{
				bParam2 = false;
			}
			if (bParam0 == 173 && !BitTest(Global_2740054.f_7024, 3))
			{
				bParam2 = false;
			}
		}
		if (bParam2)
		{
			if (!Global_79744)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_9751[iParam1 /*4*/] = { func_133(bParam0) };
						Global_9768[iParam1] = 1;
						Global_9773[iParam1] = bParam0;
					}
					else if (bParam0 == Global_21222)
					{
					}
					else
					{
						Global_9702[1 /*6*/] = { func_133(bParam0) };
...
{
	Global_114344.f_243[func_77() /*53*/].f_2[iParam0 /*5*/].f_1 = iParam1;
}
...
bool func_140(int iParam0, int iParam1)
{
	...
	return Global_114344.f_243[iParam1 /*53*/].f_2[iParam0 /*5*/].f_4;
}
...
void func_141(float fParam0)
{
	...
	while (iVar0 < 9)
	{
		if (func_10(&(Global_114344.f_18107.f_175[iVar0 /*19*/].f_5)))
		{
			func_142(&(Global_114344.f_18107.f_175[iVar0 /*19*/].f_5), (fParam0 * 60f));
		}
		iVar0++;
	}
	iVar1 = 0;
	while (iVar1 < 6)
	{
		if (func_10(&(Global_114344.f_18107.f_362[iVar1 /*3*/])))
		{
			func_142(&(Global_114344.f_18107.f_362[iVar1 /*3*/]), (fParam0 * 60f));
		}
		iVar1++;
	}
...
int func_194()
{
	if ((HUD::IS_MESSAGE_BEING_DISPLAYED() || AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING()) || Global_22585 != 0)
	{
		return 0;
	}
	return 1;
...
void func_201(var uParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	int iVar0;
	...
	if (!bParam1)
	{
		...
		{
			Global_114344.f_32754.f_4801 = func_171();
		}
	}
}
...
void func_203()
{
	...
	while (iVar0 < 4)
	{
		...
		{
			iLocal_282[iVar0] = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, Var1[iVar0 /*3*/], Var14[iVar0 /*3*/], uVar27[iVar0], false, 2);
...
int func_211(int iParam0)
{
	...
	else if (VEHICLE::IS_VEHICLE_MODEL(iParam0, -352682313))
	{
		return 1;
	}
...
int func_212(var uParam0, struct<3> Param1, bool bParam4, float fParam5)
{
	if (func_214(uParam0))
	{
...
void func_217(bool bParam0)
{
	...
	if (iLocal_76 != 9)
	{
		if (((fVar4 >= (200f / 2f) && func_194()) && !func_270(uLocal_331, 2)) || func_257(iLocal_272[0], 0))
		{
			...
			func_254(0);
			func_86("SCLUB_HOME_R", uLocal_74[0]);
			iLocal_76 = 9;
		}
	}
		...
		case 0:
			...
			if (func_194())
			{
				if (!func_270(uLocal_331, 1))
				{
					...
					func_86("SCLUB_HOME_MEET", uLocal_74[0]);
					func_254(0);
		...
		case 1:
			...
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_272[0], true), 3f, 3f, 3f, false, true, 0) || (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_338, false) && func_242(iLocal_338, iLocal_272[0], 1) <= 10f))
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_338) && (VEHICLE::GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS(iLocal_338) < 1 || (!bParam0 && !VEHICLE::IS_THIS_MODEL_A_CAR(ENTITY::GET_ENTITY_MODEL(iLocal_338)))))
				{
					...
					{
						func_69("SCLUB_SMALL_CAR", uLocal_74[0], 0);
...
void func_266()
{
	...
	func_111(-384575792, iVar0, 6, 3, func_115(), func_114(uLocal_74[0]), 0, 10000, -1, 0, -1, 0, 1);
}
	...
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Var0) > 100f)
		{
			...
			if (!func_270(uLocal_331, 128))
			{
				if (!func_34(0))
				{
					func_69("SCLUB_HOME_C_H", uLocal_74[0], 0);
...
{
	if (Global_114344.f_243[func_77() /*53*/].f_2[iParam0 /*5*/].f_1 < 0)
	{
		Global_114344.f_243[func_77() /*53*/].f_2[iParam0 /*5*/].f_1 = 0;
	}
	Global_114344.f_243[func_77() /*53*/].f_2[iParam0 /*5*/].f_1++;
}
...
void func_280(bool bParam0)
{
	switch (uLocal_74[0])
	{
		...
		case 7:
			if (bParam0)
			{
				func_86("SCLUB_HOME_MEE4", uLocal_74[0]);
			}
			else
			{
				func_86("SCLUB_HOME_MEET", uLocal_74[0]);
		...
		case 8:
			func_86("SCLUB_HOME_LIZ", uLocal_74[0]);
			break;
		
		case 9:
			func_86("SCLUB_HOME_HITCH", uLocal_74[0]);
			break;
	}
}
...
void func_299()
{
	...
	{
		case 1:
			Local_300 = { 128.1002f, -1895.001f, 22.4811f };
			Local_303 = { 128.1059f, -1896.819f, 22.6792f };
			Local_306 = { 133.9411f, -1881.89f, 22.5257f };
			Local_309 = { 130.1663f, -1893.057f, 22.3748f };
			Local_312 = { 133.4958f, -1891.641f, 22.4252f };
			fLocal_324 = 330.5705f;
			fLocal_325 = 244f;
			Local_321 = { 146.293f, -1888.049f, 22.2193f };
		...
		case 0:
			...
			Local_306 = { -178.6316f, -1629.522f, 32.1789f };
			Local_309 = { -166.1453f, -1633.102f, 32.6574f };
			Local_312 = { -166.6636f, -1633.229f, 32.6567f };
			fLocal_324 = 108.072f;
		...
		case 8:
			Local_300 = { -28.2427f, -1555.892f, 29.6918f };
			Local_303 = { -24.8589f, -1556.846f, 29.6819f };
			Local_306 = { -41.8174f, -1575.609f, 28.2831f };
			Local_309 = { -25.3404f, -1556.341f, 29.6919f };
			Local_312 = { -27.7382f, -1570.572f, 29.3f };
			fLocal_324 = 181.352f;
			fLocal_325 = 47.9206f;
			Local_321 = { Local_306 };
			fLocal_326 = fLocal_325;
		...
		case 9:
			Local_300 = { 3313.487f, 5175.831f, 18.619f };
			Local_303 = { 3310.816f, 5176.331f, 18.619f };
			Local_306 = { 3334.321f, 5161.122f, 17.2996f };
			Local_309 = { 3317.788f, 5171.707f, 17.4471f };
			Local_312 = { 3318.076f, 5171.805f, 17.4385f };
			fLocal_324 = 236.4579f;
			Local_321 = { 3322.927f, 5148.607f, 17.3141f };
