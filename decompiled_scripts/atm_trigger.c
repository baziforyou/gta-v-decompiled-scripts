			...
			if (INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == iVar1 && !PED::IS_PED_JUMPING(PLAYER::PLAYER_PED_ID()))
			{
				...
				if ((((((((((((((!PED::IS_PED_USING_ANY_SCENARIO(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) && !func_82(0)) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_528, 1f, 1f, 1f, false, true, 1)) && !PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), false)) && !func_81()) && !func_80(iScriptParam_0, 0)) && !func_79()) && ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 4f) && func_76(PLAYER::PLAYER_ID()) != 171) && !func_75(Global_4718592.f_187633)) && !func_74(Global_4718592.f_187633)) && !func_73(Global_4718592.f_187633)) && !BitTest(Global_4718592.f_28, 1)) && !func_72(PLAYER::PLAYER_ID()))
				{
					...
					if (!bVar6)
					{
						if (iLocal_625 == -1)
						{
							func_69(&iLocal_625, 4, "FINH_ATMNEAR", 0, 0, 0, 0);
						}
						bVar4 = true;
	...
	if (MISC::IS_PC_VERSION())
	{
		if (iLocal_550 == 0)
		{
			if (PAD::IS_USING_KEYBOARD_AND_MOUSE(2))
			{
				if (fLocal_551 == -1f)
				{
					fLocal_551 = PAD::GET_CONTROL_NORMAL(2, 239);
					fLocal_552 = PAD::GET_CONTROL_NORMAL(2, 240);
				}
				else if (fLocal_551 != PAD::GET_CONTROL_NORMAL(2, 239) || fLocal_552 != PAD::GET_CONTROL_NORMAL(2, 240))
				{
					GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SHOW_CURSOR");
