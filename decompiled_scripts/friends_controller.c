...
int func_70(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (uParam0->f_52)
	{
		...
		{
			MISC::SET_BIT(&(Global_114135.f_18107.f_410), bParam5);
			uParam0->f_52 = 0;
		}
	}
	else if (!func_71())
		...
		if (PED::IS_PED_INJURED(uParam1->f_2))
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam1->f_2) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (SYSTEM::VDIST2(Var3, Var6) < 150f)
				{
					...
					if (iVar9 < 6)
					{
						func_370("FR_X_INJ_1m", &(Global_2201[uParam1->f_1 /*29*/].f_3), 3, 0, 20000, 10000, 7, 0, 0, 0);
					}
				}
			}
...
void func_430(int iParam0, bool bParam1, bool bParam2)
{
	if (iParam0 < 9)
	{
		...
		{
			MISC::CLEAR_BIT(&(Global_114135.f_18107.f_175[iParam0 /*19*/].f_18), bParam1);
		}
	}
}
