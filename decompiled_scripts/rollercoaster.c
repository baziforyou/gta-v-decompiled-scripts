...
void __EntryFunction__()
{
	...
	MISC::SET_BIT(&Global_79993, 7);
	if (!CAM::DOES_CAM_EXIST(iLocal_928))
	{
		iLocal_928 = CAM::CREATE_CAM_WITH_PARAMS("DEFAULT_SCRIPTED_CAMERA", -1652.227f, -1120.93f, 22.4479f, 9.2388f, 0f, -131.6249f, 50.1098f, true, 2);
		CAM::SET_CAM_PARAMS(iLocal_928, -1652.227f, -1120.93f, 22.4479f, 9.2388f, 0f, -131.6249f, 50.1098f, 0, 1, 1, 2);
	...
	if (CAM::DOES_CAM_EXIST(iLocal_928))
	{
		CAM::SET_CAM_PARAMS(iLocal_928, -1651.501f, -1118.395f, 23.5181f, 3.435f, 0f, -152.2412f, 50.1098f, 5000, 1, 1, 2);
...
void func_17(var uParam0)
{
	...
	if (uParam0->f_3 >= 1f)
	{
		...
		{
			PAD::SET_CONTROL_SHAKE(0, iLocal_931, iLocal_932);
		}
	}
...
void func_29()
{
	...
	iLocal_923[0] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1643.524f, -1124.681f, 17.4326f, 2f, joaat("prop_roller_car_01"), true, false, true);
	iLocal_923[1] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1645.146f, -1126.613f, 17.4326f, 2f, joaat("prop_roller_car_02"), true, false, true);
	iLocal_923[2] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1646.768f, -1128.545f, 17.4326f, 2f, joaat("prop_roller_car_02"), true, false, true);
	iLocal_923[3] = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(-1648.39f, -1130.478f, 17.4326f, 2f, joaat("prop_roller_car_02"), true, false, true);
	iVar0 = 0;
	while (iVar0 < iLocal_923)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_923[iVar0]))
		{
			...
			ENTITY::SET_ENTITY_INVINCIBLE(iLocal_923[iVar0], true, 0);
		}
		iVar0++;
	}
}
...
void func_40()
{
	...
	{
		if (func_44(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_43(PLAYER::PLAYER_PED_ID());
			if (func_42(iVar0) && (!func_41(14) || Global_113292))
			{
				if (Global_114344.f_2367.f_539.f_4321 != iVar0 && func_42(Global_114344.f_2367.f_539.f_4321))
				{
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_79527[1 /*14*/] = { func_114(iVar10, iParam1, iParam2, -1) };
		if (!func_113(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_79527[1 /*14*/] = { func_114(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_79527[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_79527[1 /*14*/] = { func_114(iVar10, 14, uVar28[iVar1], -1) };
							func_81(iParam0, Global_79527[1 /*14*/].f_12, Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4);
							func_104(14);
							if (Global_79525 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_71(iVar0), Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_71(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_71(iVar0), Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4, iParam4);
						}
						func_104(iVar0);
						if (Global_79525 == 1)
						{
			...
			{
				Global_79527[1 /*14*/] = { func_114(iVar10, iVar0, func_70(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_79527[1 /*14*/] = { func_114(iVar10, 14, uVar69[iVar1], -1) };
			func_81(iParam0, Global_79527[1 /*14*/].f_12, Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4);
			func_104(14);
			if (Global_79525 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_71(iParam1), Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_71(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_71(iParam1), Global_79527[1 /*14*/].f_3, Global_79527[1 /*14*/].f_4, iParam4);
		}
		if (Global_79525 == 1)
		{
			iVar2 = 0;
...
int func_62(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_178(iParam0, Global_114344.f_2367.f_539[iVar0 /*65*/].f_64, Global_114344.f_2367.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_79527[1 /*14*/] = { func_114(iParam0, iParam1, iParam2, -1) };
...
int func_69(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_178(iParam0, Global_114344.f_2367.f_539[iVar0 /*65*/].f_61, Global_114344.f_2367.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_97(&Var1, -99, -99, Global_114344.f_2367.f_539.f_196[0], Global_114344.f_2367.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_97(&Var1, -99, -99, Global_114344.f_2367.f_539.f_196[1], Global_114344.f_2367.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_97(&Var1, -99, -99, Global_114344.f_2367.f_539.f_196[2], Global_114344.f_2367.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_104(int iParam0)
{
	...
	{
		func_112(iParam0, Global_79527[1 /*14*/].f_5, Global_79527[1 /*14*/].f_2, 2, Global_79527[1 /*14*/].f_1, 1, 0);
	}
	if (BitTest(Global_79527[1 /*14*/].f_6, 1) && BitTest(Global_79527[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_116(int iParam0)
{
	...
	func_117(&(Global_79527[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_110(func_120(iParam1, uParam0->f_2), Global_79524);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), true);
			}
			uVar0 = func_110(func_119(iParam1, uParam0->f_2), Global_79524);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_110(iVar1, Global_79524);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_123(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_117(&(Global_79527[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_117(&(Global_79527[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_117(&(Global_79527[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("outfit_only"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_79725)
		{
			...
			func_117(&(Global_79527[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("outfit_only"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
...
int func_178(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_79527[1 /*14*/] = { func_114(iVar0, iParam1, iParam2, -1) };
	if (!BitTest(Global_79527[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_178(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_178(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_79527[2 /*14*/] = { func_114(iVar0, 14, iVar4, -1) };
									if (Global_79527[2 /*14*/].f_12 == iVar3)
									{
										if (func_178(iParam0, 14, iVar4))
										{
											if (!func_67(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_79527[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_79527[2 /*14*/] = { func_114(iVar0, iVar2, iVar1, -1) };
						if (!func_67(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_79527[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_79527[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_71(iParam1)) && Global_79527[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_71(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_180(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_187(bool bParam0, bool bParam1, var uParam2, bool bParam3)
{
	int iVar0;
...
void func_189(bool bParam0)
{
	...
	func_225();
	func_224(PLAYER::PLAYER_PED_ID(), -1631.348f, -1112.651f, 12.0206f);
...
void func_196(bool bParam0)
{
	...
	else if (BitTest(Global_114344.f_20568.f_471, bParam0) || BitTest(Global_2359296[func_198() /*5571*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_114344.f_20568.f_471), bParam0);
...
int func_205(int iParam0, int iParam1)
{
	...
	if (func_215(&Global_4546910))
	{
		if (func_213(&Global_4546910, iParam0))
		{
			return 0;
		}
		if (func_206(&Global_4546910, iParam0))
		{
			return 1;
		}
	}
...
void func_209(var uParam0)
{
	...
	func_211(uParam0, (Global_4546909 - 0.5f));
}
...
void func_225()
{
	...
	{
		iLocal_923[0] = OBJECT::CREATE_OBJECT(joaat("prop_roller_car_01"), -1643.524f, -1124.681f, 17.4326f, true, true, false);
	}
	if (!func_56(iLocal_923[1]))
	{
		iLocal_923[1] = OBJECT::CREATE_OBJECT(joaat("prop_roller_car_02"), -1645.146f, -1126.613f, 17.4326f, true, true, false);
	}
	if (!func_56(iLocal_923[2]))
	{
		iLocal_923[2] = OBJECT::CREATE_OBJECT(joaat("prop_roller_car_02"), -1646.768f, -1128.545f, 17.4326f, true, true, false);
	}
	if (!func_56(iLocal_923[3]))
	{
		iLocal_923[3] = OBJECT::CREATE_OBJECT(joaat("prop_roller_car_02"), -1648.39f, -1130.478f, 17.4326f, true, true, false);
	}
	iVar0 = 0;
	while (iVar0 < iLocal_923)
	{
...
void func_230()
{
	...
	{
		func_217(13, SYSTEM::FLOOR(Global_114344.f_10198.f_3853));
	}
