...
void func_32(int iParam0, int iParam1)
{
	...
	func_33(iParam0, &(Global_114344.f_32754.f_5510));
}
...
int func_83(int iParam0, bool bParam1, struct<3> Param2, float fParam5)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_47[iParam0 /*5*/]))
	{
		...
		ENTITY::SET_ENTITY_INVINCIBLE(Local_47[iParam0 /*5*/], bVar42, 0);
...
void func_86(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7)
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
int func_97(int iParam0)
{
	if (func_101())
	{
		...
		if (func_15(Global_114333))
		{
			func_98(0);
		}
		HUD::SET_MISSION_NAME(true, "RE_TITLE");
		if (iParam0 && func_15(Global_114333))
		{
...
int func_101()
{
	switch (func_102(&Global_33341, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
{
	return func_105(iParam0, Global_44375);
}
...
int func_107(int iParam0, struct<3> Param1, float fParam4, bool bParam5)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Local_88[iParam0 /*4*/]))
	{
		...
		ENTITY::SET_ENTITY_INVINCIBLE(Local_88[iParam0 /*4*/], bVar13, 0);
...
int func_154()
{
	if ((Global_114333 == func_30() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_114334)
	{
		return 1;
	}
	return 0;
...
int func_159(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	struct<3> Var1;
	int iVar4;
	...
	if (!bVar0)
	{
		...
		if (!func_196(Global_114344.f_24999.f_43[iParam3]))
		{
			return 0;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_193()) || Global_113391) || Global_33284) || func_192()) || func_191(8, -1)) || func_190()) || func_189()) || func_188()) || func_187()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_193()) || Global_33284) || func_192()) || func_191(8, -1)) || func_188()) || func_190()) || func_189()) || func_187()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_193()) || Global_113391) || Global_33284) || func_192()) || func_191(8, -1)) || func_188()) || func_190()) || func_189()) || func_187()) || Global_114344.f_7692.f_919[iVar0] == 5) || Global_44922 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_193()) || Global_113391) || Global_33284) || func_192()) || func_191(8, -1)) || func_190()) || func_189()) || func_187()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_193() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_191(8, -1)) || func_187()) || func_186()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_193()) || Global_33284) || func_192()) || func_191(8, -1)) || func_189()) || func_188()) || func_187()) || Global_114344.f_7692.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_193()) || func_189()) || Global_113391) || Global_33284) || func_192()) || Global_45590) || func_191(8, -1)) || func_188()) || func_186()) || func_187()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_202(int iParam0)
{
	...
	if (func_154())
	{
		...
		func_205(30000);
		StringCopy(&cVar0, func_204(Global_114333, 1), 64);
		if (func_29(Global_114333) > 0)
		{
