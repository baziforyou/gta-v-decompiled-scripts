					...
					switch (iLocal_27)
					{
						case 0:
							...
							else
							{
								...
								Global_33342[iLocal_41 /*11*/].f_2 = 0;
								Global_33342[iLocal_41 /*11*/].f_6 = 1;
								Global_33342[iLocal_41 /*11*/] = MISC::GET_RANDOM_INT_IN_RANGE(0, 2);
								Global_33342[iLocal_41 /*11*/].f_1 = 0;
								Global_33342[iLocal_41 /*11*/].f_4 = 0;
								Global_33342[iLocal_41 /*11*/].f_7 = 0;
								Global_33342[iLocal_41 /*11*/].f_8 = 0;
								Global_33342[iLocal_41 /*11*/].f_10 = 0;
								fLocal_28 = -4f;
								func_56(&iLocal_24);
								func_54();
								func_53();
						...
						case 1:
							...
							{
								if (func_45() || Global_33342[iLocal_41 /*11*/].f_5)
								{
									iLocal_27 = 2;
								}
							}
						...
						case 2:
							...
							if (!func_65(iLocal_41))
							{
								if ((Global_33342[iLocal_41 /*11*/] == 3 || Global_33342[iLocal_41 /*11*/] == 2) || Global_33342[iLocal_41 /*11*/] == -1)
								{
									Global_33342[iLocal_41 /*11*/] = MISC::GET_RANDOM_INT_IN_RANGE(0, 2);
								}
								GRAPHICS::SET_TV_CHANNEL(Global_33342[iLocal_41 /*11*/]);
								GRAPHICS::SET_TV_VOLUME(fLocal_28);
							}
							else
							{
								iLocal_42 = Global_33342[iLocal_41 /*11*/];
								iLocal_43 = Global_33342[iLocal_41 /*11*/].f_1;
								GRAPHICS::SET_TV_CHANNEL_PLAYLIST(iLocal_42, func_42(iLocal_43), Global_33342[iLocal_41 /*11*/].f_9);
								GRAPHICS::SET_TV_CHANNEL(iLocal_42);
								if (Global_33342[iLocal_41 /*11*/].f_7)
								{
									Global_33342[iLocal_41 /*11*/].f_5 = 0;
									Global_33342[iLocal_41 /*11*/].f_7 = 0;
								}
							}
							Global_33342[iLocal_41 /*11*/].f_2 = 1;
							func_41(133, 1);
							func_41(131, 1);
							func_41(132, 1);
							iLocal_27 = 3;
						...
						case 3:
							if (Global_33342[iLocal_41 /*11*/].f_4)
							{
								iLocal_27 = 6;
							}
							if (Global_33342[iLocal_41 /*11*/].f_7 && func_65(iLocal_41))
							{
								Global_33342[iLocal_41 /*11*/].f_7 = 0;
								iLocal_27 = 6;
							}
...
void func_1()
{
	if (iLocal_41 != -1)
	{
		Global_33342[iLocal_41 /*11*/] = GRAPHICS::GET_TV_CHANNEL();
	}
...
int func_16()
{
	if (!func_65(iLocal_41))
	{
		if (((((((func_32(&iLocal_24) >= 1f && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_86, 1f, 1f, 1.5f, false, true, 0)) && INTERIOR::GET_INTERIOR_FROM_ENTITY(iLocal_35) == INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID())) && !func_31(8, -1)) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false)) && PED::IS_PED_HEADING_TOWARDS_POSITION(PLAYER::PLAYER_PED_ID(), Local_29, 90f)) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) && !STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
		{
			...
			{
				func_30();
				func_29(&iLocal_40, 3, "TV_HLP5", 0, 0, 0, 0);
			}
...
void func_17()
{
	if (iLocal_83 == 0)
	{
		...
		{
			func_44(&iLocal_40);
			func_29(&iLocal_40, 3, "TV_HLP6", 0, 0, 0, 0);
			func_26();
		}
	}
	else
...
int func_45()
{
	...
	if (Global_33342[iLocal_41 /*11*/].f_8)
	{
		func_44(&iLocal_40);
		return 0;
	}
	if (iLocal_40 == -1)
	{
		func_29(&iLocal_40, 3, "TV_HLP1", 0, 0, 0, 0);
		return 0;
	}
	if (func_27(iLocal_40, 1))
	{
		func_44(&iLocal_40);
		func_56(&iLocal_24);
		Global_33342[iLocal_41 /*11*/].f_7 = 1;
		if (AUDIO::REQUEST_AMBIENT_AUDIO_BANK("SAFEHOUSE_MICHAEL_SIT_SOFA", false, -1))
		{
			AUDIO::PLAY_SOUND_FRONTEND(-1, "MICHAEL_SOFA_TV_ON_MASTER", 0, true);
		}
...
void func_60()
{
	...
	if (ENTITY::GET_ENTITY_MODEL(iLocal_35) == joaat("prop_tv_03"))
	{
		...
		{
			iLocal_41 = 0;
			Local_77 = { -9.8135f, -1440.913f, 31.3654f };
	...
	else if (ENTITY::GET_ENTITY_MODEL(iLocal_35) == joaat("prop_trev_tv_01"))
	{
		...
		{
			iLocal_41 = 2;
			Local_77 = { 1978.23f, 3819.65f, 34.2724f };
			Local_80 = { 0f, 0f, -105.15f };
			Local_86 = { 1978.33f, 3819.717f, 32.4501f };
			func_61();
	...
	else if (ENTITY::GET_ENTITY_MODEL(iLocal_35) == joaat("prop_tv_flat_02"))
	{
		...
		{
			iLocal_41 = 3;
			Local_77 = { -1160.502f, -1520.76f, 10.7393f };
			Local_80 = { 0f, 0f, 60.061f };
			Local_86 = { -1160.143f, -1520.495f, 9.6555f };
...
void func_63()
{
	...
	if (Global_33342[iLocal_41 /*11*/].f_10 == 0)
	{
		if (iLocal_84 == 1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_38))
			{
				ENTITY::SET_ENTITY_INVINCIBLE(iLocal_38, false, 0);
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_35))
			{
				ENTITY::SET_ENTITY_INVINCIBLE(iLocal_35, false, 0);
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_37))
			{
				ENTITY::SET_ENTITY_INVINCIBLE(iLocal_37, false, 0);
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_36))
			{
				ENTITY::SET_ENTITY_INVINCIBLE(iLocal_36, false, 0);
			}
			iLocal_84 = 0;
		}
	}
	else if (iLocal_84 == 0)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_38))
		{
			ENTITY::SET_ENTITY_INVINCIBLE(iLocal_38, true, 0);
		}
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_35))
		{
			ENTITY::SET_ENTITY_INVINCIBLE(iLocal_35, true, 0);
		}
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_37))
		{
			ENTITY::SET_ENTITY_INVINCIBLE(iLocal_37, true, 0);
		}
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_36))
		{
			ENTITY::SET_ENTITY_INVINCIBLE(iLocal_36, true, 0);
		}
		iLocal_84 = 1;
	}
}
...
void func_69()
{
	...
	{
		func_1();
		Global_33342[iLocal_41 /*11*/].f_6 = 0;
		Global_33342[iLocal_41 /*11*/].f_7 = 0;
		Global_33342[iLocal_41 /*11*/].f_8 = 0;
		Global_33342[iLocal_41 /*11*/].f_4 = 0;
		Global_33342[iLocal_41 /*11*/].f_5 = 0;
		Global_33342[iLocal_41 /*11*/].f_2 = 0;
		Global_33342[iLocal_41 /*11*/] = -1;
		Global_33342[iLocal_41 /*11*/].f_1 = 0;
		Global_33342[iLocal_41 /*11*/].f_10 = 0;
	}
