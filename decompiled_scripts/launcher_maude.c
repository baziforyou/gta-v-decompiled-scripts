	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113431[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_281(&(Global_113431[Var0.f_0 /*10*/].f_9));
			}
		}
		func_265(&Var0, 1);
	}
...
int func_205(var uParam0, bool bParam1)
{
	...
	func_120(*uParam0, &Var0);
	if ((func_242(*uParam0) || func_240(*uParam0)) || Global_79990 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
{
	if ((func_241() && Global_101893.f_11 == 6) && iParam0 == func_179(&(Global_101893.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_245(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
...
int func_246(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
