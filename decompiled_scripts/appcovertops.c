...
void func_1()
{
	if (((!BitTest(uLocal_140, 7) && !BitTest(uLocal_140, 6)) && iLocal_278 == 1) && !func_8())
	{
		if (!func_7())
		{
...
{
	if (func_11(&uLocal_284, "GNRCAUD", func_34(iParam0), 8, 0, 0, 0))
	{
		iLocal_143 = -1;
	}
}
...
void func_35()
{
	...
	if ((!BitTest(uLocal_140, 4) && !func_8()) && iLocal_278 == 1)
	{
	...
	else if (BitTest(uLocal_140, 4))
	{
		if (!func_40(&uLocal_282))
		{
			func_39(&uLocal_282, 0, 0);
		}
		else if (func_38(&uLocal_282, iLocal_142, 0))
		{
...
int func_36()
{
	if ((func_5(15378, -1) || BitTest(uLocal_140, 5)) && func_5(15379, -1))
	{
		return 1;
	}
	return 0;
...
void func_41()
{
	...
	if (BitTest(uLocal_140, 0))
	{
		...
		{
			iVar0 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_450);
			iVar1 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iLocal_451);
			switch (iVar0)
			{
				case 102:
...
void func_59()
{
	switch (func_197())
	{
		case 1:
			...
			func_60(&(Global_2684745.f_783), iLocal_141, 1);
			func_272(0, 0);
			break;
...
int func_60(var uParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 < func_195(iParam2))
	{
		...
		if (iVar1 != -1)
		{
			func_191(&(Global_794954.f_4[iVar1 /*95*/]));
			func_190();
			switch (iParam2)
			{
				case 0:
				...
				case 2:
					...
					if (func_186(Global_794954.f_144215[iVar1 /*13*/].f_1))
					{
						func_189(235);
					}
					else
			...
			func_182(Global_794954.f_4[iVar1 /*95*/].f_77);
			func_180();
			func_179();
			func_178();
			func_177();
...
void func_62(var uParam0, int iParam1, int iParam2, struct<3> Param3, var uParam6, struct<3> Param7, bool bParam10, bool bParam11, var uParam12, var uParam13, int iParam14, bool bParam15, var uParam16)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
		...
		if (func_138(Var0))
		{
			if (func_155(PLAYER::PLAYER_ID(), 0))
			{
				if (ENTITY::DOES_ENTITY_EXIST(func_135()) && !ENTITY::IS_ENTITY_DEAD(func_135(), false))
				{
					...
					if (func_134(Global_1845225[PLAYER::PLAYER_ID() /*874*/].f_825, 1, 0))
					{
	...
	else if (func_128(Global_4718592.f_131616) || BitTest(uParam16, 2))
	{
	...
	else if (func_126(Global_4718592.f_131616) || BitTest(uParam16, 1))
	{
		Var0 = { 347.2638f, 4867.324f, -59.2679f };
		Var3 = { 1.2933f, 0.0747f, -34.6934f };
		fVar6 = 50f;
	}
	else if (BitTest(uParam16, 4) || func_125(Global_4718592.f_131616))
	{
	...
	else if (BitTest(uParam16, 8) || func_117(Global_4718592.f_131616))
	{
	}
	...
	else if (func_112(Global_4718592.f_131616))
	{
		Var0 = { 800.2757f, -3051.393f, 10.5728f };
		Var3 = { 3.1956f, 0f, -8.4268f };
		fVar6 = 50f;
	}
	else if (func_111(Global_4718592.f_131616))
	{
	...
	else if (func_110(Global_4718592.f_131616))
	{
		Var0 = { -1587.15f, 2771.544f, 27.1587f };
		Var3 = { -19.4886f, 0f, 8.8248f };
		fVar6 = 60f;
	}
	else if (func_109(Global_4718592.f_131616))
	{
	...
	{
		func_102();
		func_101(&Var11, 144, Global_1845225[PLAYER::PLAYER_ID() /*874*/].f_260.f_36);
		if (!func_138(Var11))
		{
			Var0 = { Var11 };
		}
		func_95(&Var11, 144, Global_1845225[PLAYER::PLAYER_ID() /*874*/].f_260.f_36);
		Var3 = { Var11 };
	}
...
int func_70()
{
	if (func_155(PLAYER::PLAYER_ID(), 0))
	{
		if (Global_1845225[PLAYER::PLAYER_ID() /*874*/].f_825 != func_17())
		{
			if (func_71(Global_1845225[PLAYER::PLAYER_ID() /*874*/].f_825, 0, 1))
			{
				if (func_134(Global_1845225[PLAYER::PLAYER_ID() /*874*/].f_825, 1, 0))
				{
					return 0;
...
void func_81(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && (PLAYER::IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			else
			{
				if (!func_85(iVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar27))
				{
					...
					if (func_82(Global_4718592.f_190775))
					{
...
void func_96(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	struct<6> Var0[2];
	struct<3> Var13;
...
Vector3 func_97(struct<3> Param0, float fParam3)
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
struct<6> func_98(int iParam0, int iParam1)
{
	struct<6> Var0;
	bool bVar6;
	int iVar23;
...
int func_105()
{
	...
	if (!func_103() && !((Global_1939227 || Global_1574973) && func_106()))
	{
		return 0;
	}
	return 1;
...
void func_108(var uParam0, var uParam1, float fParam2)
{
...
void func_118(var uParam0, var uParam1, float fParam2)
{
	if (func_120(Global_4718592.f_131616))
	{
...
int func_129(int iParam0)
{
	if (iParam0 != func_17())
	{
		...
		{
			if (Global_2658016[iParam0 /*467*/].f_324.f_8 != -1 && Global_2658016[iParam0 /*467*/].f_324.f_11 != func_17())
			{
				return func_130(Global_2658016[iParam0 /*467*/].f_324.f_8) == 25;
			}
		}
	}
	return 0;
...
int func_132(int iParam0)
{
	if (iParam0 != func_17())
	{
		if (func_71(iParam0, 1, 1))
		{
			...
			{
				return func_130(Global_2658016[iParam0 /*467*/].f_324.f_8) == 6;
			}
		}
	}
	return 0;
...
int func_133(int iParam0)
{
	if (iParam0 != func_17())
	{
		if (func_71(iParam0, 1, 1))
		{
			if (Global_2658016[iParam0 /*467*/].f_324.f_8 != -1 && Global_2658016[iParam0 /*467*/].f_324.f_11 != func_17())
			{
				return func_130(Global_2658016[iParam0 /*467*/].f_324.f_8) == 5;
			}
		}
	}
	return 0;
...
{
	if (func_153(Global_4718592.f_131616))
	{
	...
	if (func_146(Global_4718592.f_190775))
	{
		return "MenuMGRemixIn";
	}
	if (func_145(Global_4718592.f_190775) && BitTest(Global_4718592.f_192213.f_3376, 2))
	{
...
void func_158(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
...
void func_168(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (iParam0 == 0)
	{
		return;
...
void func_183(struct<13> Param0)
{
	if (func_184(Param0))
	{
...
void func_201()
{
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_449, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(205), -1f, -1f, -1f, -1f);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 206, true);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 206))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_449, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(206), -1f, -1f, -1f, -1f);
	}
	if (PAD::IS_USING_CURSOR(2))
	{
		...
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_449, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(301), -1f, -1f, -1f, -1f);
		}
		PAD::ENABLE_CONTROL_ACTION(2, 187, true);
		if (PAD::IS_CONTROL_JUST_PRESSED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_449, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(300), -1f, -1f, -1f, -1f);
		}
		if (PAD::IS_CONTROL_JUST_RELEASED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_449, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(300), -1f, -1f, -1f, -1f);
		}
		if (PAD::IS_CONTROL_JUST_RELEASED(2, 188))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_449, "SET_INPUT_RELEASE_EVENT", SYSTEM::TO_FLOAT(301), -1f, -1f, -1f, -1f);
		}
	}
	else
	{
		...
		if (PAD::IS_CONTROL_JUST_PRESSED(2, 188))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_449, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(188), -1f, -1f, -1f, -1f);
		}
		PAD::ENABLE_CONTROL_ACTION(2, 187, true);
		if (PAD::IS_CONTROL_JUST_PRESSED(2, 187))
		{
			GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_449, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(187), -1f, -1f, -1f, -1f);
		}
	}
	PAD::ENABLE_CONTROL_ACTION(2, 189, true);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 189))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_449, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(189), -1f, -1f, -1f, -1f);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 190, true);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 190))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_449, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(190), -1f, -1f, -1f, -1f);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 201, true);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 201))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_449, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(201), -1f, -1f, -1f, -1f);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 202, true);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 202))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_449, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(202), -1f, -1f, -1f, -1f);
	...
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_449, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(203), -1f, -1f, -1f, -1f);
	}
	PAD::ENABLE_CONTROL_ACTION(2, 204, true);
	if (PAD::IS_CONTROL_JUST_PRESSED(2, 204))
	{
		GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD_WITH_NUMBER(iLocal_449, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(204), -1f, -1f, -1f, -1f);
	}
	if (PAD::IS_USING_CURSOR(2))
	{
	...
	else
	{
		...
		if (((iVar0 != 127 || iLocal_452 != 127) || iVar1 != 127) || iLocal_453 != 127)
		{
	...
	if (((iVar2 != 127 || iLocal_454 != 127) || iVar3 != 127) || iLocal_455 != 127)
	{
...
void func_214(float fParam0, float fParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
int func_220(int iParam0)
{
	if (iParam0 != func_17())
	{
		...
		else if ((Global_1575086 && iParam0 == PLAYER::PLAYER_ID()) && func_71(iParam0, 1, 0))
		{
			return Global_2658016[iParam0 /*467*/].f_324.f_8 != -1;
		}
	}
...
void func_225()
{
	...
	{
		func_227(1);
		func_226(&uLocal_284, 2, 0, "AGENT14", 0, 1);
	}
}
...
void func_229(int iParam0)
{
	...
	iLocal_144 = func_266(func_4(), 5);
	iVar1 = func_193(func_45(iParam0), 1);
	iVar2 = func_57(iParam0);
	bVar3 = iLocal_144 >= iVar2;
	sVar4 = func_265(&(Global_76895[func_45(iParam0) /*6*/]));
	fVar5 = 0f;
	fVar6 = 0f;
	if (bVar3)
	{
	...
	if (iVar1 != -1)
	{
		if (!func_262())
		{
			while (!func_258(Global_794954.f_4[iVar1 /*95*/].f_60))
			{
				if (!func_40(&uLocal_280))
				{
					func_39(&uLocal_280, 0, 0);
				}
				else if (func_38(&uLocal_280, 750, 0))
				{
					iVar1 = -1;
				}
				else
			...
			if (iVar1 != -1)
			{
				func_230(&fVar5, &fVar6, 0, 9, 0, 0, MISC::GET_HASH_KEY(&(Global_794954.f_4[iVar1 /*95*/])));
			}
			if (fVar5 == 1f)
			{
				fVar5 = 0f;
	...
	if (iVar1 != -1)
	{
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_LITERAL_STRING(&(Global_794954.f_4[iVar1 /*95*/].f_22));
		GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("FMMC_OFFLN_HD");
		iVar0 = 0;
		while (iVar0 < 8)
		{
			HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Local_146[iVar0 /*16*/]));
			iVar0++;
		}
		GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
	}
...
void func_230(float* fParam0, float* fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
...
void func_231(int iParam0, int iParam1, int iParam2, float* fParam3, bool bParam4)
{
...
void func_232(int iParam0, int iParam1, float* fParam2, bool bParam3)
{
	int iVar0;
	var uVar1;
...
int func_235(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	switch (iParam0)
	{
		case 0:
...
int func_253(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		if (func_254(Global_4718592.f_190775, 0))
		{
			return 1;
		}
	}
...
bool func_258(int iParam0)
{
	...
	if (bVar0)
	{
		...
		while (iVar8 < 8)
		{
			StringCopy(&(Local_146[iVar8 /*16*/]), "", 64);
			iVar8++;
		}
		...
		while (!bVar9)
		{
			...
			{
				StringCopy(&(Local_146[iVar7 /*16*/]), HUD::GET_CHARACTER_FROM_AUDIO_CONVERSATION_FILENAME_WITH_BYTE_LIMIT(sVar4, iVar5, iVar6, 63), 64);
				iVar5 = (iVar5 + HUD::GET_LENGTH_OF_LITERAL_STRING(&(Local_146[iVar7 /*16*/])));
				iVar7++;
			}
		}
	}
