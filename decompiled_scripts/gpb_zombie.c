		...
		switch (iLocal_248)
		{
			...
			case 8:
				...
				else if (iLocal_438 == 1)
				{
					...
					{
						func_53(Global_114289[iLocal_249], iLocal_295, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_238, &Local_370, &Local_354));
					}
				}
				break;
			...
			case 9:
				...
				bVar36 = func_62();
				bVar37 = func_63();
				func_52(Global_114289[iLocal_249]);
				if (!bVar37 && (!bVar36 || bLocal_435))
				{
					if (bLocal_503)
					{
						Global_114289[iLocal_249] = uLocal_502;
					}
					else
					{
...
int func_8()
{
	if (Global_114289[iLocal_249] == 3 && (iLocal_295 >= 4 && iLocal_295 <= 12))
	{
		return 1;
	}
	return 0;
...
void func_18()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_22(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_20(iVar0) && (!func_19(14) || Global_113292))
			{
...
void func_55()
{
	...
	func_58(Global_114289[iLocal_249] + 1, &sVar0, &Var8);
	...
	PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_238, false, false);
	func_56(Global_114289[iLocal_249]);
}
...
void func_98(int iParam0)
{
	...
	func_101(&(Global_114344.f_20121), iParam0);
...
{
	return func_112(Global_114344.f_20121, uParam0);
}
