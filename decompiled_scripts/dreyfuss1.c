...
{
	if (BitTest(Global_101893.f_20, 17))
	{
		return 0;
	}
...
int func_217(int iParam0, int iParam1)
{
	...
	if (func_227(&Global_4546910))
	{
		if (func_225(&Global_4546910, iParam0))
		{
			return 0;
		}
		if (func_218(&Global_4546910, iParam0))
		{
			return 1;
		}
	}
...
void func_221(var uParam0)
{
	...
	func_223(uParam0, (Global_4546909 - 0.5f));
}
	...
	switch (iLocal_153)
	{
		...
		case 1:
			...
			if (!func_443(iLocal_154))
			{
				...
				if (!BitTest(Global_114344.f_18578.f_382, 0))
				{
					MISC::SET_BIT(&(Global_114344.f_18578.f_382), 0);
				}
				func_299(4);
			}
...
int func_258(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
bool func_263(int iParam0, int iParam1, float fParam2, bool bParam3)
{
...
bool func_266(char* sParam0, int iParam1, char* sParam2)
{
...
int func_276(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_283() || func_282(Global_4718592.f_190775)) || func_281())
	{
...
int func_277(int iParam0)
{
	if (iParam0 != func_235())
	{
		...
		else if ((Global_1575086 && iParam0 == PLAYER::PLAYER_ID()) && func_278(iParam0, 1, 0))
		{
			return Global_2658016[iParam0 /*467*/].f_324.f_8 != -1;
		}
	}
		...
		case 1:
			...
			else
			{
				if (func_443(Local_84.f_35[0]))
				{
					...
					if (((!iLocal_330 && !iLocal_331) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(iLocal_154)) && !ENTITY::IS_ENTITY_AT_COORD(Local_84.f_35[0], -1474.445f, 519.4703f, 117.0069f, 15f, 15f, 15f, false, true, 0))
					{
...
bool func_305(struct<3> Param0, struct<3> Param3, float fParam6)
{
	...
	switch (iLocal_153)
	{
		case 0:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_159))
			{
				...
				iLocal_159 = VEHICLE::CREATE_VEHICLE(iLocal_160, -1482.366f, 529.0344f, 117.2725f, 201.5764f, true, true, false);
...
void func_316(int* iParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, bool bParam5, int iParam6)
{
	if (HUD::DOES_BLIP_EXIST(*iParam0))
	{
		if (bParam5)
			...
			switch (iLocal_560)
			{
				...
				case 2:
					if (CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						...
						{
							func_382(-1457.842f, 485.8195f, 114.2016f, -1474.227f, 482.811f, 117.2016f, 3f, Local_538, fLocal_541, 1, 1, 1, 0, 0);
							func_382(-1473.984f, 510.0452f, 114.6034f, -1474.227f, 482.811f, 118.2016f, 4f, Local_538, fLocal_541, 1, 1, 1, 0, 0);
							func_382(-1472.341f, 508.3621f, 114.6158f, -1475.958f, 520.1589f, 120.0448f, 10f, Local_538, fLocal_541, 1, 1, 1, 0, 0);
							func_334(Local_538, fLocal_541, 0, 145);
						}
						else
						{
							func_382(-1457.842f, 485.8195f, 114.2016f, -1474.227f, 482.811f, 117.2016f, 3f, Local_542, fLocal_545, 1, 1, 1, 0, 0);
							func_382(-1473.984f, 510.0452f, 114.6034f, -1474.227f, 482.811f, 118.2016f, 4f, Local_542, fLocal_545, 1, 1, 1, 0, 0);
							func_382(-1472.341f, 508.3621f, 114.6158f, -1475.958f, 520.1589f, 120.0448f, 10f, Local_542, fLocal_545, 1, 1, 1, 0, 0);
				...
				case 3:
					...
					else
					{
						...
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(iLocal_154, -1475.366f, 500.3797f, 116.6013f, 3f, 20000, 0.25f, 1, 40000f);
						}
					}
					break;
			}
...
void func_322(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	if (bParam0)
	{
...
int func_329(bool bParam0, bool bParam1, var uParam2, bool bParam3)
{
	int iVar0;
...
void func_334(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_104903.f_4))
	{
		...
		{
			if (func_381(24) != Global_104903.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_378(ENTITY::GET_ENTITY_COORDS(Global_104903.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_335(Global_104903.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_335(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
...
void func_336(int iParam0, int iParam1, int iParam2)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_114344.f_32754.f_4801 = func_355();
			}
...
void func_337(int iParam0, int iParam1)
{
	...
	func_373(iParam0, &(Global_114344.f_32754.f_5510));
}
...
int func_366(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_289(Global_114344.f_32754.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_289(Global_114344.f_2367.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_289(Global_114344.f_2367.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_369(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_366(&(Global_78534.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_371(iParam0);
			func_370(uParam1, &(Global_114344.f_32754.f_69[Global_78534.f_555[0 /*21*/].f_14 /*78*/]));
...
int func_378(struct<3> Param0, int iParam3, var uParam4, var uParam5)
{
	int iVar0;
...
void func_382(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
...
int func_385(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_386(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_388(struct<3> Param0, int iParam3)
{
	return func_389(Global_104903.f_2890.f_12.f_66, Param0, iParam3);
}

int func_389(int iParam0, struct<3> Param1, int iParam4)
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_396(int iParam0, float fParam1, int iParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)
{
...
{
	if (((!func_422(0) || Global_80015) || Global_80003 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_79999)
...
{
	return func_424(iParam0, Global_44375);
}
...
void func_425(int iParam0)
{
	...
	if (!func_436())
	{
		...
		func_435(PLAYER::PLAYER_PED_ID(), -1462.177f, 485.6856f, 115.2016f, 97.1913f, 0, 1);
	}
	func_2(&iLocal_159);
	func_4(&iLocal_154);
	func_2(&(Local_84.f_35[0]));
...
void func_428(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
...
int func_433(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
int func_435(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
...
void func_442()
{
	...
	func_438();
	MISC::CLEAR_BIT(&(Global_114344.f_18578.f_382), 0);
...
int func_445()
{
	return PED::ADD_SCENARIO_BLOCKING_AREA(-1495.496f, 519.4606f, 100.8889f, -1429.111f, 468.1972f, 120.9696f, false, true, true, true, 1);
}
...
int func_448(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
...
int func_474()
{
	...
	iVar0 = func_475(&(Global_101893.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_478()
{
	...
	{
		if (func_473(&(Global_101893.f_3)) > -1)
		{
			return 1;
		}
	}
