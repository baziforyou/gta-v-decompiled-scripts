...
void __EntryFunction__()
{
	...
	if (MISC::GET_GAME_TIMER() < Global_33546 + 10000 && !func_107())
	{
		func_115(0);
	}
	...
	Global_33546 = MISC::GET_GAME_TIMER();
	...
	while (iVar0 == 1)
	{
		...
		if (bLocal_502)
		{
			...
			StringIntConCat(&cVar44, Global_114289[iLocal_249], 64);
			...
			StringIntConCat(&cVar44, iLocal_253[Global_114289[iLocal_249]], 64);
		...
		switch (iLocal_248)
		{
			...
			case 8:
				...
				else if (!func_62())
				{
					...
					if (iLocal_295 < iLocal_253[Global_114289[iLocal_249]] && iVar39)
					{
						func_63();
						iLocal_248 = 7;
					}
				...
				else if (iLocal_438 == 1)
				{
					...
					{
						func_52(Global_114289[iLocal_249], iLocal_295, ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_238, &Local_370, &Local_354));
					}
				}
				break;
			...
			case 9:
				...
				bVar36 = func_61();
				bVar37 = func_62();
				func_51(Global_114289[iLocal_249]);
				if (!bVar37 && (!bVar36 || bLocal_435))
				{
					if (bLocal_501)
					{
						Global_114289[iLocal_249] = uLocal_500;
					}
					else
					{
						Global_114289[iLocal_249]++;
					}
					if (!Global_114289[iLocal_249] < iLocal_250)
					{
						Global_114289[iLocal_249] = 0;
					}
					func_101(0, 1);
					iLocal_248 = 0;
				}
...
void func_17()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_21(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_19(iVar0) && (!func_18(14) || Global_113292))
			{
...
void func_54()
{
	...
	func_57(Global_114289[iLocal_249] + 1, &sVar0, &Var8);
	...
	PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(iLocal_238, false, false);
	func_55(Global_114289[iLocal_249]);
}
...
int func_58()
{
	...
	Var0 = { Local_306 };
	StringIntConCat(&Var0, Global_114289[iLocal_249] + 1, 16);
	func_49(&uLocal_35, 3, iLocal_238, &Local_234, 0, 1);
	if (bLocal_435)
	{
		iVar4 = 1;
...
void func_66(char* sParam0)
{
	...
	StringIntConCat(sParam0, Global_114289[iLocal_249] + 1, 16);
}
...
void func_68(int iParam0, bool bParam1)
{
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		if (func_77(iParam0))
		{
			if (!func_75(iParam0))
			{
				MISC::SET_BIT(&(Global_114344.f_26438.f_2), iVar0);
				if (!bParam1)
				{
...
int func_75(int iParam0)
{
	if (func_77(iParam0))
	{
		return BitTest(Global_114344.f_26438.f_2, iParam0);
	}
	return 0;
}
...
int func_76(int iParam0)
{
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		return BitTest(Global_114344.f_26438.f_2, iVar0);
	}
	return 0;
}
...
void func_97(int iParam0)
{
	...
	func_100(&(Global_114344.f_20121), iParam0);
...
int func_106()
{
	if (BitTest(Global_114344.f_18578[58 /*6*/], 0) && !BitTest(Global_114344.f_18578[58 /*6*/], 3))
	{
		return 1;
	}
	return 0;
...
int func_111()
{
	if (BitTest(Global_114344.f_18578[60 /*6*/], 0) && !BitTest(Global_114344.f_18578[60 /*6*/], 3))
	{
		return 0;
	}
	if (BitTest(Global_114344.f_18578[61 /*6*/], 0) && !BitTest(Global_114344.f_18578[61 /*6*/], 3))
	{
		return 0;
	}
	if (BitTest(Global_114344.f_18578[62 /*6*/], 3))
	{
		return 0;
	}
	if ((BitTest(Global_114344.f_18578[58 /*6*/], 2) || BitTest(Global_114344.f_18578[59 /*6*/], 2)) || BitTest(Global_114344.f_18578[62 /*6*/], 2))
	{
		return 1;
	}
	return 0;
...
{
	return func_113(Global_114344.f_20121, uParam0);
}
