...
void __EntryFunction__()
{
	...
	iLocal_39 = 49;
	iLocal_40 = 64;
	Local_49 = { 2194.135f, 5593.278f, 53.70383f };
	Local_71 = { 2203.27f, 5549.918f, 93.09485f };
	Local_74 = { 2199.629f, 5640.293f, 52.23926f };
	fLocal_77 = 81.5f;
...
{
	Global_114344.f_24999.f_7 = iParam0;
}
...
void func_44()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_48(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_46(iVar0) && (!func_45(14) || Global_113292))
			{
...
int func_58(int iParam0)
{
	if (func_61())
	{
		...
		if (func_38(Global_114333))
		{
			func_59(0);
		}
		HUD::SET_MISSION_NAME(true, "RE_TITLE");
		if (iParam0 && func_38(Global_114333))
		{
...
int func_61()
{
	switch (func_62(&Global_33341, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
			...
			switch (iLocal_125)
			{
				case 0:
					if (!iLocal_88[iLocal_123])
					{
						...
						{
							if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_71, Local_74, fLocal_77, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 2205.918f, 5633.455f, 55.7472f, 15f, 15f, 40f, false, true, 0))
							{
								if (!func_56())
								{
...
bool func_92()
{
	return Global_114344.f_24999.f_7;
}
...
void func_96()
{
	...
	if ((STREAMING::HAS_MODEL_LOADED(joaat("g_m_y_salvagoon_01")) && STREAMING::HAS_MODEL_LOADED(joaat("bobcatxl"))) && STREAMING::HAS_MODEL_LOADED(joaat("prop_cash_case_01")))
	{
		...
		iLocal_108[0] = VEHICLE::CREATE_VEHICLE(joaat("bobcatxl"), 2209.17f, 5572.897f, 52.7565f, 255.5161f, true, true, false);
		...
		iLocal_108[1] = VEHICLE::CREATE_VEHICLE(joaat("bobcatxl"), 2195.473f, 5607.506f, 52.5648f, 168.4012f, true, true, false);
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_108[1], true, false);
		VEHICLE::SET_VEHICLE_EXTRA(iLocal_108[1], 1, false);
		iVar0 = 0;
		MISC::SET_BIT(&iVar0, 1);
		iLocal_111 = OBJECT::CREATE_PICKUP_ROTATE(joaat("pickup_money_case"), Local_49, -1.368082f, 0.230633f, 176.8749f, iVar0, MISC::GET_RANDOM_INT_IN_RANGE(40000, 100000), 2, true, joaat("prop_cash_case_01"));
		Local_52[0 /*3*/] = { 2205.769f, 5631.985f, 55.553f };
		fLocal_78[0] = 352.2203f;
		Local_52[1 /*3*/] = { 2210.584f, 5580.684f, 52.8132f };
		fLocal_78[1] = 300.5012f;
		Local_52[2 /*3*/] = { 2201.302f, 5589.279f, 52.9354f };
		fLocal_78[2] = 53.1602f;
		Local_52[3 /*3*/] = { 2202.535f, 5613.367f, 52.6781f };
		fLocal_78[3] = 70f;
...
int func_111()
{
	if ((Global_114333 == func_53() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_114334)
	{
		return 1;
	}
	return 0;
...
int func_115(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (!bVar0)
	{
		...
		if (!func_136(Global_114344.f_24999.f_43[iParam3]))
		{
			return 0;
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_134()) || Global_113391) || Global_33284) || func_133()) || func_88(8, -1)) || func_132()) || func_131()) || func_130()) || func_129()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_134()) || Global_33284) || func_133()) || func_88(8, -1)) || func_130()) || func_132()) || func_131()) || func_129()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_134()) || Global_113391) || Global_33284) || func_133()) || func_88(8, -1)) || func_130()) || func_132()) || func_131()) || func_129()) || Global_114344.f_7692.f_919[iVar0] == 5) || Global_44922 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_134()) || Global_113391) || Global_33284) || func_133()) || func_88(8, -1)) || func_132()) || func_131()) || func_129()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_134() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_88(8, -1)) || func_129()) || func_128()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_134()) || func_131()) || Global_113391) || Global_33284) || func_133()) || Global_45590) || func_88(8, -1)) || func_130()) || func_128()) || func_129()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_143(int iParam0)
{
	...
	if (func_111())
	{
		...
		func_146(30000);
		StringCopy(&cVar0, func_145(Global_114333, 1), 64);
		if (func_52(Global_114333) > 0)
		{
