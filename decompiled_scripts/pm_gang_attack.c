	...
	switch (iLocal_34)
	{
		case 0:
			...
			if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
			{
				...
				while (iVar4 <= 5)
				{
					if (ENTITY::DOES_ENTITY_EXIST(Global_113051.f_225[iVar4]))
					{
						uLocal_282[iVar4] = Global_113051.f_225[iVar4];
						Global_113051.f_225[iVar4] = 0;
				...
				while (iVar4 <= 1)
				{
					if (ENTITY::DOES_ENTITY_EXIST(Global_113051.f_222[iVar4]))
					{
						uLocal_279[iVar4] = Global_113051.f_222[iVar4];
						Global_113051.f_222[iVar4] = 0;
...
void func_52(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7)
{
	if (!PED::IS_PED_INJURED(iParam0))
	{
...
int func_58()
{
	return func_59(Global_113051.f_20, Global_113051.f_29);
}
