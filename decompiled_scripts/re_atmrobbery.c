			...
			if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
			{
				switch (iLocal_92)
				{
					...
					case 1:
						...
						if (iLocal_111 == 0)
						{
							iLocal_111 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(101, Local_93, 30000f);
						}
				...
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_98, fLocal_133, fLocal_133, fLocal_133, false, true, 0) && !func_101())
				{
					...
					if (!func_130())
					{
						if (PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
						{
							if (func_97(1, 0, 1))
							{
								if (!BitTest(Global_9075, 11) || func_96())
								{
			...
			switch (iLocal_148)
			{
				case 0:
					if (((!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_PRONE(PLAYER::PLAYER_PED_ID())) && !TASK::IS_PED_GETTING_UP(PLAYER::PLAYER_PED_ID()))
					{
						if (bLocal_130)
						{
							if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_93, -712.9f, -819.32f, 22.73f, true) < 5f && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -709.9229f, -824.0863f, 22.0751f, -715.2137f, -824.2247f, 25.01217f, 3.25f, false, true, 0))
							{
							...
							else if (!PED::IS_PED_INJURED(iLocal_98))
							{
								...
								else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_93, -821.33f, -1082.43f, 10.14f, true) < 5f && OBJECT::IS_POINT_IN_ANGLED_AREA(Local_124, -826.1744f, -1083.943f, 9.137519f, -811.6559f, -1075.567f, 13.88779f, 6f, false, true))
								{
									Local_124 = { -814.0593f, -1082.483f, 10.0671f };
									Local_127.f_2 = 275.5752f;
								}
								else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_93, -387.12f, 6045.79f, 30.5f, true) < 5f && OBJECT::IS_POINT_IN_ANGLED_AREA(Local_124, -377.5788f, 6033.821f, 29.29119f, -373.0138f, 6029.14f, 33.75382f, 4.75f, false, true))
								{
									Local_124 = { -375.0627f, 6030.533f, 30.5313f };
									Local_127.f_2 = 222.9049f;
								}
								else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_93, -387.12f, 6045.79f, 30.5f, true) < 5f && OBJECT::IS_POINT_IN_ANGLED_AREA(Local_124, -381.4607f, 6031.481f, 29.24971f, -376.6766f, 6026.68f, 33.76656f, 3f, false, true))
								{
									Local_124 = { -379.7835f, 6029.472f, 30.5014f };
							...
							{
								if (OBJECT::IS_POINT_IN_ANGLED_AREA(Local_124, -538.4412f, -1214.903f, 16.79794f, -520.3268f, -1223.249f, 20.556f, 6.5f, false, true))
								{
						...
						else if (bLocal_107 == 4)
						{
							...
							{
								Local_124 = { 183.6065f, 6636.653f, 30.6299f };
							...
							if (!VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, false))
							{
								...
								if (ENTITY::IS_ENTITY_AT_COORD(iVar0, Local_124, (Local_349.f_1 + 1f), (Local_349.f_1 + 1f), 3f, false, true, 0) || ENTITY::IS_ENTITY_AT_COORD(iVar0, PED::GET_ANIM_INITIAL_OFFSET_POSITION(cLocal_360, sLocal_362, Local_124, Local_127, 0f, 2), (Local_349.f_1 + 1f), (Local_349.f_1 + 1f), 3f, false, true, 0))
								{
									if (func_68(Local_93, -526.58f, -1222.79f, 17.46f, 10f, 0) && (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -529.7477f, -1218.399f, 16.78482f, -538.9778f, -1213.756f, 20.53685f, 7.5f, false, true, 0) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -529.7477f, -1218.399f, 16.78482f, -520.9798f, -1222.305f, 20.55204f, 7.5f, false, true, 0)))
									{
										...
										{
											Var16 = { 2.9f, 12f, 8f };
											Local_119 = { -522.4418f, -1214.57f, 17.1848f };
									...
									else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_93, -203.72f, -861.8f, 29.27f, true) < 5f && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -197.7616f, -865.9772f, 27.31116f, -191.161f, -849.0546f, 32.89275f, 10.25f, false, true, 0))
									{
										Var16 = { 2.9f, 12f, 8f };
									...
									else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_93, -387.12f, 6045.79f, 30.5f, true) < 5f && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -390.4536f, 6044.05f, 29.99868f, -380.4771f, 6032.985f, 33.24879f, 6f, false, true, 0))
									{
										Var16 = { 2.9f, 12f, 8f };
									...
									else if (MISC::GET_DISTANCE_BETWEEN_COORDS(Local_93, -2956.78f, 488.19f, 14.47f, true) < 5f && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -2955.234f, 492.4626f, 13.80307f, -2967.116f, 493.0511f, 17.05663f, 9.75f, false, true, 0))
									{
										Var16 = { 2.9f, 12f, 8f };
...
void func_7(bool bParam0)
{
	...
	else if (BitTest(Global_114344.f_20568.f_471, bParam0) || BitTest(Global_2359296[func_9() /*5571*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_114344.f_20568.f_471), bParam0);
...
int func_21(int iParam0, int iParam1)
{
	...
	if (func_31(&Global_4546910))
	{
		if (func_29(&Global_4546910, iParam0))
		{
			return 0;
		}
		if (func_22(&Global_4546910, iParam0))
		{
			return 1;
		}
	}
...
void func_25(var uParam0)
{
	...
	func_27(uParam0, (Global_4546909 - 0.5f));
}
...
void func_39()
{
	...
	{
		if (func_42(Global_114344.f_2367.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_41(PLAYER::PLAYER_PED_ID());
			if (func_40(iVar0) && (!func_33(14) || Global_113292))
			{
				if (Global_114344.f_2367.f_539.f_4321 != iVar0 && func_40(Global_114344.f_2367.f_539.f_4321))
				{
...
int func_134(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	struct<3> Var0;
...
bool func_137(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar4;
...
int func_138(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_141(int iParam0, int iParam1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
Vector3 func_143(struct<3> Param0)
{
	float fVar0;
	float fVar1;
...
bool func_147(int iParam0, int iParam1, float fParam2)
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_148(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_149(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_151(int iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_152(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_153()
{
	...
	{
		func_154(&uLocal_370, iLocal_97, "ATM_CHASEHINT", 0, 1, 1, 1);
	}
}
...
int func_162(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_169() || func_168(Global_4718592.f_190775)) || func_167())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			iVar0 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false);
...
int func_163(int iParam0)
{
	if (iParam0 != func_129())
	{
		...
		else if ((Global_1575086 && iParam0 == PLAYER::PLAYER_ID()) && func_164(iParam0, 1, 0))
		{
			return Global_2658016[iParam0 /*467*/].f_324.f_8 != -1;
		}
	}
...
void func_171(var uParam0, int iParam1, struct<3> Param2, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_174(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_188(int iParam0)
{
	if (func_190())
	{
		...
		if (func_189(Global_114333))
		{
			func_103(0);
		}
		HUD::SET_MISSION_NAME(true, "RE_TITLE");
		if (iParam0 && func_189(Global_114333))
		{
...
int func_190()
{
	switch (func_191(&Global_33341, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
{
	return func_194(iParam0, Global_44375);
}
...
int func_198()
{
	...
	if (bLocal_107 == 1)
	{
		...
		if (SYSTEM::VDIST(Local_93, -203.758f, -861.738f, 29.2684f) < 5f)
		{
			...
			fLocal_123 = 160.391f;
			Local_346 = { -259.0351f, -865.7119f, 28f };
			Local_349 = { -130.3981f, -908.8096f, 40f };
	...
	else if (bLocal_107 == 2)
	{
		...
		fLocal_122 = 78.25f;
		Local_119 = { 288.9906f, -1248.443f, 28.2847f };
		fLocal_123 = 75.9756f;
		Local_346 = { 266.3643f, -1313.829f, 28.59103f };
		Local_349 = { 265.1489f, -1215.932f, 36.20192f };
		STREAMING::REQUEST_MODEL(iLocal_156);
		while (!STREAMING::HAS_MODEL_LOADED(iLocal_156))
		{
			if (func_209())
	...
	{
		func_222();
		Local_119 = { -1587.15f, -539.9152f, 34.3644f };
		fLocal_123 = 327f;
		Local_346 = { -1596.203f, -474.8844f, 32f };
		Local_349 = { -1595.572f, -565.8368f, 48f };
	}
	else if (bLocal_107 == 4)
	{
		func_222();
		Local_116 = { 181.2355f, 6632.627f, 30.5732f };
		fLocal_122 = 182f;
		Local_119 = { 200.0727f, 6630.587f, 30.517f };
		fLocal_123 = 165f;
		Local_346 = { 178.1817f, 6660.375f, 31f };
		Local_349 = { 179.1249f, 6530.043f, 38f };
...
int func_203(char* sParam0, char* sParam1, int iParam2)
{
...
void func_206(var uParam0, bool bParam1, int iParam2, char* sParam3, int iParam4)
{
	int iVar0;
...
int func_225()
{
	if ((Global_114333 == func_226() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_114334)
	{
		return 1;
	}
	return 0;
...
int func_227(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)
{
...
int func_237(struct<3> Param0, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (!bVar0)
	{
		...
		if (!func_272(Global_114344.f_24999.f_43[iParam3]))
		{
			return 0;
		}
...
void func_241(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	func_242(func_253(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_242(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_270()) || Global_33284) || func_269()) || func_60(8, -1)) || func_266()) || func_268()) || func_267()) || func_265()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_270()) || Global_113391) || Global_33284) || func_269()) || func_60(8, -1)) || func_266()) || func_268()) || func_267()) || func_265()) || Global_114344.f_7692.f_919[iVar0] == 5) || Global_44922 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_270()) || Global_113391) || Global_33284) || func_269()) || func_60(8, -1)) || func_268()) || func_267()) || func_265()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_270() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_60(8, -1)) || func_265()) || func_264()) || Global_114344.f_7692.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_270()) || Global_33284) || func_269()) || func_60(8, -1)) || func_267()) || func_266()) || func_265()) || Global_114344.f_7692.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_270()) || Global_113391) || Global_33284) || func_269()) || func_60(8, -1)) || func_266()) || func_264()) || func_268()) || func_267()) || func_265())
						{
							return 0;
						}
						break;
...
void func_280(int iParam0)
{
	...
	if (func_225())
	{
		...
		func_284(30000);
		StringCopy(&cVar0, func_283(Global_114333, 1), 64);
		if (func_282(Global_114333) > 0)
		{
...
void func_301(int iParam0, int iParam1)
{
	...
	if (iParam1 <= func_282(iParam0))
	{
		...
		if (!func_310(51))
		{
			func_307("RE_REWARD", 1, 0, 4000, 10000, func_216(), 0, 138, 0);
			func_306(51);
		}
		if (func_189(iParam0))
		{
...
void func_302(int iParam0, var uParam1, var uParam2)
{
	bool bVar0;
...
void func_303()
{
	...
	{
		func_34(13, SYSTEM::FLOOR(Global_114344.f_10198.f_3853));
	}
...
void func_307(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	func_308(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_308(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)
{
	int iVar0;
