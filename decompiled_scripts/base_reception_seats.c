...
int func_70()
{
	if (Global_1845062 != func_60())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("base_reception_seats", Global_1845062, true, 0))
		{
			return 0;
		}
...
void func_71()
{
	...
	iVar0[0] = 0;
	iVar0[1] = 1;
	func_74(2, &uLocal_120, &iVar0);
	iVar0[0] = 2;
	iVar0[1] = 3;
	func_74(3, &uLocal_120, &iVar0);
	iVar0[0] = 4;
	iVar0[1] = 5;
	func_74(4, &uLocal_120, &iVar0);
	func_72(&uLocal_120, 6333);
}
