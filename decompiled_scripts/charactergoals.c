		...
		switch (iLocal_16)
		{
			case 0:
				if (iLocal_17[0])
				{
					...
					{
						Global_23705[3 /*42*/].f_27[0] = func_51(2);
						func_50(2, 32, Global_23705[3 /*42*/].f_27[0]);
					}
					StringCopy(&(Global_23705[3 /*42*/]), "PA_TREV1", 16);
					StringCopy(&(Global_23705[3 /*42*/].f_4), "PA_TREV1", 16);
					Global_23705[3 /*42*/].f_8 = 0;
					Global_23705[3 /*42*/].f_9 = 1;
					StringCopy(&(Global_23705[3 /*42*/].f_10[1 /*4*/]), "PA_TREV1A", 16);
					Global_23705[3 /*42*/].f_37[1] = 0;
					if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
					{
						Global_23705[3 /*42*/].f_27[1] = func_51(2);
					}
					func_43(2, 3, 1, 1);
					func_40("PA_TREV1A", Global_23705[3 /*42*/].f_27[1]);
					iLocal_16 = 1;
				}
				break;
			...
			case 1:
				if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
				{
					...
					if (func_39(2, 999999))
					{
						...
						Global_23705[3 /*42*/].f_37[1] = 1;
						Global_23705[3 /*42*/].f_8 = 1;
...
void func_5(bool bParam0)
{
	...
	else if (BitTest(Global_114344.f_20568.f_471, bParam0) || BitTest(Global_2359296[func_7() /*5571*/].f_681.f_10, bParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_114344.f_20568.f_471), bParam0);
...
int func_19(int iParam0, int iParam1)
{
	...
	if (func_29(&Global_4546910))
	{
		if (func_27(&Global_4546910, iParam0))
		{
			return 0;
		}
		if (func_20(&Global_4546910, iParam0))
		{
			return 1;
		}
	}
...
void func_23(var uParam0)
{
	...
	func_25(uParam0, (Global_4546909 - 0.5f));
}
...
int func_44(var uParam0, var uParam1, bool bParam2, int iParam3)
{
	...
	func_45(Global_23704);
	Global_23874[Global_23704 /*9*/].f_1 = uParam1;
	Global_23874[Global_23704 /*9*/] = uParam0;
	if (iParam3 == 0)
	{
	}
	else
	{
		Global_23874[Global_23704 /*9*/].f_8 = iParam3;
	}
	if (bParam2)
	{
	}
...
void func_45(int iParam0)
{
	...
	Global_23874[iParam0 /*9*/].f_2 = iVar0;
	Global_23874[iParam0 /*9*/].f_2.f_1 = iVar1;
	Global_23874[iParam0 /*9*/].f_2.f_2 = iVar2;
	Global_23874[iParam0 /*9*/].f_2.f_3 = iVar3;
	Global_23874[iParam0 /*9*/].f_2.f_4 = uVar4;
	Global_23874[iParam0 /*9*/].f_2.f_5 = iVar5;
}
...
int func_47()
{
	...
	iVar0 = 0;
	Global_23704 = 3;
	Global_23874[Global_23704 /*9*/].f_2 = -1;
	Global_23874[Global_23704 /*9*/].f_2.f_1 = 0;
	Global_23874[Global_23704 /*9*/].f_2.f_2 = 0;
	Global_23874[Global_23704 /*9*/].f_2.f_3 = 0;
	Global_23874[Global_23704 /*9*/].f_2.f_5 = 99999;
	while (iVar0 < 2)
	{
		if (Global_23874[iVar0 /*9*/].f_8 == 0 || Global_23874[iVar0 /*9*/].f_8 == 1)
		{
			if (!func_48(Global_23874[iVar0 /*9*/].f_2, Global_23874[Global_23704 /*9*/].f_2))
			{
				Global_23704 = iVar0;
			}
		}
