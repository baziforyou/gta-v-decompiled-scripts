...
int func_28(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (BitTest(Global_114344.f_10053.f_108, func_31(func_32(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
		...
		if (fVar6 > 200f)
		{
			...
			if (func_61())
			{
				...
				if (!HUD::DOES_BLIP_EXIST(iLocal_388))
				{
					...
					HUD::SET_BLIP_NAME_FROM_TEXT_FILE(iLocal_388, "B_WRE");
...
{
	return func_73(iParam0, Global_44375);
}
